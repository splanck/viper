...
- **Review (2026-07-15):** Verified and fixed. Nothing in the tree references
  ...
  `docs/internals/generated-files.md` all consume `x86_64_encodings.json` exclusively, and the YAML had
...
- **Review (2026-07-16):** Confirmed and resolved the harmful metadata gaps in
  ...
  audit, and documented the Time coverage of the override tables in `docs/tools/cli.md`. No registry
