...
| D-009 | Runtime object lifetime policy | `runtime-changes.md` §10 | partial | Explicit destroy/despawn invalidation and diagnostics |  | Phase 4/7 | `test_rt_game3d`; `docs/viperlib/graphics/game3d.md` | Core world/entity ownership covered; imported templates/effects/animation diagnostics still open |
