...
| TEST-015 | Regression | `ctest --test-dir build -L graphics3d` stays green | `roadmap.md` Testing strategy | done | `ctest --test-dir build -L graphics3d --output-on-failure` 44/44 passed |  | Includes Phase 1/2 Game3D probes, synthetic input, quality profiles, and model asset loading probe |
...
| DOC-011 | API reference | Every new runtime function and Game3D API area | `roadmap.md` Phase 7 | partial | pending | `docs/viperlib/graphics/game3d.md` | Phase 1 and Phase 2 Game3D surfaces documented; future API areas pending |
