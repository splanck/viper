...
| R-VAL-003 | `ctest --test-dir build -L graphics3d` passes | `runtime-changes.md` Validation | done | 44/44 graphics3d passed | Includes Phase 1 and Phase 2 Game3D C/Zia probes plus migrated `walk_min` |
