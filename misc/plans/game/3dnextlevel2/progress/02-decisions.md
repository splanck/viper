...
| D-LIGHT | Lighting path | Keep forward shaders and add capability-gated clustered/forward+ behavior; do not switch to deferred rendering for this plan. | `test_rt_canvas3d`; `test_rt_canvas3d_gpu_paths`; `progress/03-runtime-contracts.md` R-LIT rows | 2026-05-29 | Software many-light baseline is authoritative until GPU clustered support lands. |
