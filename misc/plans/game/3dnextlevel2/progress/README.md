...
plan files (`../README.md`, `../roadmap.md`, `../runtime-changes.md`,
`../api-spec.md`, `../carryover.md`) describe the target; these files record
delivery state, tests, docs, waivers, and proof links.
