...
- `NineSlice2D` (`Viper.Graphics`, ctor `runtime.def:1943`): `New(obj,i64,i64,i64,i64)`, `DrawToPixels(obj,i64,i64,i64,i64)`. Also `Viper.Game.UI.NineSlice` (ctor `5654`): `New(obj,i64,i64,i64,i64)`, prop `Tint`, `Draw(obj,i64,i64,i64,i64)`
...
| `sound.zia` | 521 | `class SoundManager` @ **70** wraps `Viper.Sound.SoundBank` (bind @ 60); `setup(basePath)` @ **100** registers WAVs **110-121** with Synth fallback **125-160**. **`menu_move` + `menu_select` already exist** (`playMenuMove` @ **367**, `playMenuSelect` @ **361**). Only **`menuBack`** is new for #6. `gen_sounds.c` (11 KB) generates 12 WAVs in `sounds/` (no `menu_back.wav` yet). |
