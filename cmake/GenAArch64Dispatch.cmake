...
set(_out "")
_append(_out "// Generated from tools/spec/aarch64_encodings.json")
_append(_out "// DO NOT EDIT - regenerate with CMake (cmake/GenAArch64Dispatch.cmake)")
_append(_out "")
_append(_out "// This file contains the opcode dispatch logic for emitInstruction")
_append(_out "")
...
foreach(_i RANGE 0 ${_LAST})
  ...
  elseif(_ENUM STREQUAL "Bl")
    _append(_out "    case K::${_ENUM}:")
    _append(_out "        os << \"  bl \" << mi.ops[0].label << \"\\n\";")
    _append(_out "        break;")
    continue()
  elseif(_ENUM STREQUAL "AdrPage")
    _append(_out "    case K::${_ENUM}:")
    _append(_out "        os << \"  adrp \" << rn(reg(mi.ops[0])) << \", \" << mi.ops[1].label << \"@PAGE\\n\";")
    _append(_out "        break;")
    continue()
  elseif(_ENUM STREQUAL "AddPageOff")
    _append(_out "    case K::${_ENUM}:")
    _append(_out "        os << \"  add \" << rn(reg(mi.ops[0])) << \", \" << rn(reg(mi.ops[1])) << \", \"")
    _append(_out "           << mi.ops[2].label << \"@PAGEOFF\\n\";")
    _append(_out "        break;")
    continue()
