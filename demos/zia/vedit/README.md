...
- `main.zia` - Full-featured editor with toolbar, tabs, and status bar
- `simple.zia` - Minimal example showing basic GUI usage
- `widgets_demo.zia` - Comprehensive widget showcase (form, list, progress, etc.)
...
./build/tools/ilc/ilc demos/zia/vedit/simple.zia --run

# Or the full editor
./build/tools/ilc/ilc demos/zia/vedit/main.zia --run
```
