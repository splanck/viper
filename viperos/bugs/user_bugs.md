...
**Description:**
After running the storage subsystem tests, fsck.viperfs reports:
```
...
Also fixed `tools/mkfs.viperfs.cpp` to write correct `free_blocks` count in
