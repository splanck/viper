...
ViperOS targets QEMU’s `virt` machine and leans on virtio-mmio devices to get storage, networking, input, and entropy
during bring-up.
...
Virtio devices communicate via virtqueues; ViperOS implements a virtqueue helper in:
