...
//===----------------------------------------------------------------------===//
//
// File: include/viperos/types.hpp
...
/**
 * @file types.hpp
 * @brief Shared fixed-width type aliases for ViperOS kernel and user-space.
 *
 * @details
 * This header provides the fundamental fixed-width integer and size aliases
 * used throughout ViperOS. It is designed for freestanding environments
