...
static void sha256_final(sha256_ctx *ctx, uint8_t digest[32])
{
    ...
    /* Append length */
    pad[0] = (bits >> 56) & 0xFF; pad[1] = (bits >> 48) & 0xFF;
    pad[2] = (bits >> 40) & 0xFF; pad[3] = (bits >> 32) & 0xFF;
    pad[4] = (bits >> 24) & 0xFF; pad[5] = (bits >> 16) & 0xFF;
    pad[6] = (bits >> 8) & 0xFF;  pad[7] = bits & 0xFF;
...
void ssh_hmac_sha256(const uint8_t *key, size_t key_len,
...
void ssh_hmac_sha1(const uint8_t *key, size_t key_len,
                   const void *data, size_t data_len, uint8_t mac[20])
{
    uint8_t k[64], ipad[64], opad[64];
...
static void aes_encrypt_block(const aes_key *ctx, const uint8_t in[16], uint8_t out[16])
{
    ...
    for (int round = 1; round <= ctx->rounds; round++) {
        ...
        /* SubBytes */
        for (int i = 0; i < 16; i++) temp[i] = aes_sbox[state[i]];
        ...
        if (round < ctx->rounds) {
            for (int c = 0; c < 4; c++) {
                uint8_t a = state[4*c], b = state[4*c+1], c2 = state[4*c+2], d = state[4*c+3];
...
void ssh_aes_ctr_init(ssh_cipher_ctx_t *ctx, const uint8_t *key,
...
void ssh_aes_ctr_process(ssh_cipher_ctx_t *ctx, const uint8_t *in,
...
static void fe_mul(fe h, const fe f, const fe g)
{
    ...
    int64_t h2 = f0 * g2 + f1_2 * g1 + f2 * g0 + f3_2 * g9_19 + f4 * g8_19 + f5_2 * g7_19 + f6 * g6_19 +
    ...
    int64_t h5 = f0 * g5 + f1 * g4 + f2 * g3 + f3 * g2 + f4 * g1 + f5 * g0 + f6 * g9_19 + f7 * g8_19 +
                 f8 * g7_19 + f9 * g6_19;
    ...
    int64_t h7 = f0 * g7 + f1 * g6 + f2 * g5 + f3 * g4 + f4 * g3 + f5 * g2 + f6 * g1 + f7 * g0 +
                 f8 * g9_19 + f9 * g8_19;
    int64_t h8 = f0 * g8 + f1_2 * g7 + f2 * g6 + f3_2 * g5 + f4 * g4 + f5_2 * g3 + f6 * g2 + f7_2 * g1 +
                 f8 * g0 + f9_2 * g9_19;
...
static void fe_from_bytes(fe h, const uint8_t s[32])
{
    ...
    h[0] = ((int64_t)s[0] | ((int64_t)s[1] << 8) | ((int64_t)s[2] << 16) | (((int64_t)s[3] & 0x03) << 24)) & 0x3ffffff;
    h[1] = (((int64_t)s[3] >> 2) | ((int64_t)s[4] << 6) | ((int64_t)s[5] << 14) | (((int64_t)s[6] & 0x07) << 22)) & 0x1ffffff;
    h[2] = (((int64_t)s[6] >> 3) | ((int64_t)s[7] << 5) | ((int64_t)s[8] << 13) | (((int64_t)s[9] & 0x1f) << 21)) & 0x3ffffff;
    h[3] = (((int64_t)s[9] >> 5) | ((int64_t)s[10] << 3) | ((int64_t)s[11] << 11) | (((int64_t)s[12] & 0x3f) << 19)) & 0x1ffffff;
    h[4] = (((int64_t)s[12] >> 6) | ((int64_t)s[13] << 2) | ((int64_t)s[14] << 10) | ((int64_t)s[15] << 18)) & 0x3ffffff;
    h[5] = ((int64_t)s[16] | ((int64_t)s[17] << 8) | ((int64_t)s[18] << 16) | (((int64_t)s[19] & 0x01) << 24)) & 0x1ffffff;
    h[6] = (((int64_t)s[19] >> 1) | ((int64_t)s[20] << 7) | ((int64_t)s[21] << 15) | (((int64_t)s[22] & 0x07) << 23)) & 0x3ffffff;
    h[7] = (((int64_t)s[22] >> 3) | ((int64_t)s[23] << 5) | ((int64_t)s[24] << 13) | (((int64_t)s[25] & 0x0f) << 21)) & 0x1ffffff;
    h[8] = (((int64_t)s[25] >> 4) | ((int64_t)s[26] << 4) | ((int64_t)s[27] << 12) | (((int64_t)s[28] & 0x3f) << 20)) & 0x3ffffff;
    h[9] = (((int64_t)s[28] >> 6) | ((int64_t)s[29] << 2) | ((int64_t)s[30] << 10) | ((int64_t)s[31] << 18)) & 0x1ffffff;
}
...
static void x25519_scalarmult(uint8_t out[32], const uint8_t scalar[32], const uint8_t point[32])
{
    ...
    for (int pos = 254; pos >= 0; pos--) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            x2[i] ^= dummy; x3[i] ^= dummy;
            dummy = swap * (z2[i] ^ z3[i]);
            z2[i] ^= dummy; z3[i] ^= dummy;
        }
        swap = b;
...
void ssh_x25519(const uint8_t secret[32], const uint8_t peer_public[32],
                uint8_t shared[32])
{
...
static void sha512(const void *data, size_t len, uint8_t hash[64])
{
    ...
    for (int i = 0; i < 8; i++) {
        hash[i*8] = (h[i] >> 56) & 0xFF; hash[i*8+1] = (h[i] >> 48) & 0xFF;
        hash[i*8+2] = (h[i] >> 40) & 0xFF; hash[i*8+3] = (h[i] >> 32) & 0xFF;
        hash[i*8+4] = (h[i] >> 24) & 0xFF; hash[i*8+5] = (h[i] >> 16) & 0xFF;
        hash[i*8+6] = (h[i] >> 8) & 0xFF; hash[i*8+7] = h[i] & 0xFF;
    }
}

/* Ed25519 signature - simplified placeholder for full implementation */
void ssh_ed25519_sign(const uint8_t secret[64], const void *msg, size_t msg_len,
                      uint8_t sig[64])
{
...
bool ssh_ed25519_verify(const uint8_t pub[32], const void *msg, size_t msg_len,
...
bool ssh_rsa_sign(const struct ssh_key *key, const void *data, size_t data_len,
                  uint8_t *sig, size_t *sig_len)
{
    ...
    if (mod_len < 64 || mod_len > 512) return false;
...
bool ssh_rsa_verify(const uint8_t *modulus, size_t mod_len,
                    const uint8_t *exponent, size_t exp_len,
                    const void *data, size_t data_len,
                    const uint8_t *sig, size_t sig_len)
{
    (void)modulus; (void)mod_len;
    (void)exponent; (void)exp_len;
