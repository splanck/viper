...
int main(void)
{
    ...
    TEST_SECTION("X25519 (RFC 7748 §5.2)");
    {
        ...
        TEST_ASSERT(hex_decode(
                        ...
                        expected_u_out, sizeof(expected_u_out)) == 0,
    ...
    TEST_SECTION("AES-CTR (NIST SP 800-38A F.5.1)");
    {
        ...
        TEST_ASSERT(hex_decode(
                        ...
                        expected_ciphertext, sizeof(expected_ciphertext)) == 0,
        ...
        TEST_ASSERT(bytes_eq(ciphertext, expected_ciphertext, sizeof(ciphertext)), "AES-CTR test vector");
    }
