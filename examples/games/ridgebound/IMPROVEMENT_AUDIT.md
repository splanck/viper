...
| 7 | Navigable night | Stronger moon, ambient/IBL floor, softer night shadows, and a night-scaled 27 m player light retain terrain and water structure. The smoke capture measures 31.391 mean scene luminance versus the configured minimum of 14. |
...
| 19 | Scalable performance | Three presets change vegetation LOD, water, weather, shadows/cascades, SSAO, and occlusion while keeping the authored grade. The final aggregate run measured the warmed Metal Cinematic frame at 8.331 ms against a 50 ms 960x540 budget. |
