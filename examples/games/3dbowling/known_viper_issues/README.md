...
```sh
./build/src/tools/viper/viper run \
...
## NL-VIPER-002 — same-size DrawText2DAA textures alias on Metal
...
## NL-VIPER-003 — intermittent material/overlay Pixels interference
...
issue probes were correct (for example, a missing `Viper.Math` binding was
