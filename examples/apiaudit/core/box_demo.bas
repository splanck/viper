...
'        EqStr; Viper.Runtime.Unsafe.ValueType compatibility hook
' =============================================================================
...
DIM vt0 AS OBJECT
vt0 = Viper.Runtime.Unsafe.ValueType(0)
PRINT "ValueType(0) - i64 type obj created"
DIM vt1 AS OBJECT
vt1 = Viper.Runtime.Unsafe.ValueType(1)
PRINT "ValueType(1) - f64 type obj created"
DIM vt2 AS OBJECT
vt2 = Viper.Runtime.Unsafe.ValueType(2)
PRINT "ValueType(2) - i1 type obj created"
DIM vt3 AS OBJECT
vt3 = Viper.Runtime.Unsafe.ValueType(3)
