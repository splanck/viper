...
' --- Len (initial) ---
PRINT "--- Len (initial) ---"
PRINT "Len: "; Viper.Threads.Channel.get_Count(ch)
...
PRINT "Len after Send: "; Viper.Threads.Channel.get_Count(ch)

' --- TrySend ---
PRINT "--- TrySend ---"
DIM ok1 AS INTEGER = Viper.Threads.Channel.TrySend(ch, Viper.Core.Box.Str("world"))
PRINT "TrySend: "; ok1
PRINT "Len after TrySend: "; Viper.Threads.Channel.get_Count(ch)
