' =============================================================================
' API Audit: Zanna.Threads.Monitor (BASIC)
' =============================================================================
...
PRINT "=== API Audit: Zanna.Threads.Monitor ==="
...
PRINT "--- TryEnter (free) ---"
DIM ok2 AS INTEGER = Zanna.Threads.Monitor.TryEnter(obj)
...
PRINT "--- TryEnterFor ---"
Zanna.Threads.Monitor.Enter(obj)
DIM ok3 AS INTEGER = Zanna.Threads.Monitor.TryEnterFor(obj, 10)
...
DIM obj2 AS OBJECT = Zanna.Collections.Seq.New()
Zanna.Threads.Monitor.Enter(obj2)
PRINT "Monitor on second object acquired"
Zanna.Threads.Monitor.Exit(obj2)
