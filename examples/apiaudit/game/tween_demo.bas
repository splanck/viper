' tween_demo.bas - Comprehensive API audit for Zanna.Game.Tween
...
' --- LerpI64 (static) ---
PRINT "--- LerpI64 ---"
PRINT Zanna.Game.Tween.LerpI64(0, 100, 0.0)   ' 0
PRINT Zanna.Game.Tween.LerpI64(0, 100, 0.5)   ' 50
PRINT Zanna.Game.Tween.LerpI64(0, 100, 1.0)   ' 100

' --- Ease (static: t, ease_type) ---
PRINT "--- Ease ---"
PRINT Zanna.Game.Tween.Ease(0.0, 0)   ' 0.0 (linear at 0)
PRINT Zanna.Game.Tween.Ease(0.5, 0)   ' 0.5 (linear at 0.5)
PRINT Zanna.Game.Tween.Ease(1.0, 0)   ' 1.0 (linear at 1)
