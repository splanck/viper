...
PRINT "  ConnectResult(host, port) -> Result"
PRINT "  ConnectForResult(host, port, timeout_ms) -> Result"
PRINT "  ConnectOptionsResult(host, port, ca_file, alpn, verify_cert, timeout_ms) -> Result"
