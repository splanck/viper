...
PRINT "P tag count: "; Viper.Collections.Seq.get_Count(texts)
DIM ti AS INTEGER
FOR ti = 0 TO Viper.Collections.Seq.get_Count(texts) - 1
...
PRINT "H1 count: "; Viper.Collections.Seq.get_Count(h1s)
