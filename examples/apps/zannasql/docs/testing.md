...
zanna run examples/apps/zannasql/tests/test_basic_crud.zia
zanna run examples/apps/zannasql/tests/test_advanced.zia

# Specific feature areas
zanna run examples/apps/zannasql/tests/test_constraints.zia
zanna run examples/apps/zannasql/tests/test_functions.zia
zanna run examples/apps/zannasql/tests/test_subquery.zia
zanna run examples/apps/zannasql/tests/test_index.zia
zanna run examples/apps/zannasql/tests/test_sql_features.zia

# Multi-database and persistence
zanna run examples/apps/zannasql/tests/test_multidb.zia
zanna run examples/apps/zannasql/tests/test_persistence.zia

# Storage engine internals
zanna run examples/apps/zannasql/tests/test_storage.zia
zanna run examples/apps/zannasql/tests/test_btree.zia
zanna run examples/apps/zannasql/tests/test_engine.zia
zanna run examples/apps/zannasql/tests/test_wal.zia
zanna run examples/apps/zannasql/tests/test_txn.zia

# Stress tests and native codegen validation
zanna run examples/apps/zannasql/tests/test_storage_persistence.zia
zanna run examples/apps/zannasql/tests/test_storage_stress.zia
zanna run examples/apps/zannasql/tests/test_native_stress.zia
zanna run examples/apps/zannasql/tests/test_native_edge.zia
zanna run examples/apps/zannasql/tests/test_native_torture.zia
zanna run examples/apps/zannasql/tests/test_native_extreme.zia

# Phase feature tests
zanna run examples/apps/zannasql/tests/test_phase1.zia
zanna run examples/apps/zannasql/tests/test_phase2.zia
zanna run examples/apps/zannasql/tests/test_phase3.zia
zanna run examples/apps/zannasql/tests/test_phase3_txn.zia
zanna run examples/apps/zannasql/tests/test_phase4_functions.zia
zanna run examples/apps/zannasql/tests/test_phase4_cte.zia
zanna run examples/apps/zannasql/tests/test_phase4_multitable.zia
zanna run examples/apps/zannasql/tests/test_phase4_window.zia
zanna run examples/apps/zannasql/tests/test_phase4_datetime.zia

# Multi-user and server tests
zanna run examples/apps/zannasql/tests/test_multiuser.zia
zanna run examples/apps/zannasql/tests/test_system_views.zia
zanna run examples/apps/zannasql/tests/test_tempdb.zia
zanna run examples/apps/zannasql/tests/test_auth.zia
zanna run examples/apps/zannasql/tests/test_pg_wire.zia
zanna run examples/apps/zannasql/tests/test_extended_query.zia

# Triggers, sequences, stored functions, composite indexes, pg_catalog, JSON
zanna run examples/apps/zannasql/tests/test_phase17_triggers.zia
zanna run examples/apps/zannasql/tests/test_phase18_sequences.zia
zanna run examples/apps/zannasql/tests/test_phase19_procedures.zia
zanna run examples/apps/zannasql/tests/test_phase20_composite_indexes.zia
zanna run examples/apps/zannasql/tests/test_phase21_pg_catalog.zia
zanna run examples/apps/zannasql/tests/test_phase25_json.zia
zanna run examples/apps/zannasql/tests/test_phase26_vacuum.zia
zanna run examples/apps/zannasql/tests/test_phase27_pg_stat.zia
zanna run examples/apps/zannasql/tests/test_phase28_partition.zia
zanna run examples/apps/zannasql/tests/test_phase29_extensions.zia
zanna run examples/apps/zannasql/tests/test_phase30_prepared.zia
zanna run examples/apps/zannasql/tests/test_phase32_cursors.zia
zanna run examples/apps/zannasql/tests/test_phase33_savepoints.zia
zanna run examples/apps/zannasql/tests/test_phase34_copy.zia
zanna run examples/apps/zannasql/tests/test_phase35_call.zia
zanna run examples/apps/zannasql/tests/test_phase36_arrays.zia
zanna run examples/apps/zannasql/tests/test_phase37_matviews.zia
zanna run examples/apps/zannasql/tests/test_phase38_expressions.zia
zanna run examples/apps/zannasql/tests/test_phase39_ctas.zia
zanna run examples/apps/zannasql/tests/test_phase40_aggregates.zia
zanna run examples/apps/zannasql/tests/test_phase41_do_blocks.zia
zanna run examples/apps/zannasql/tests/test_phase42_insert.zia
zanna run examples/apps/zannasql/tests/test_phase43_session.zia
zanna run examples/apps/zannasql/tests/test_phase44_sysfuncs.zia
zanna run examples/apps/zannasql/tests/test_phase45_alter_col.zia
zanna run examples/apps/zannasql/tests/test_phase46_sqlfuncs.zia
zanna run examples/apps/zannasql/tests/test_phase47_recursive_cte.zia
zanna run examples/apps/zannasql/tests/test_phase48_math.zia
zanna run examples/apps/zannasql/tests/test_phase49_strings.zia
zanna run examples/apps/zannasql/tests/test_phase50_datetime.zia
zanna run examples/apps/zannasql/tests/test_phase51_regex.zia
zanna run examples/apps/zannasql/tests/test_phase52_inherit.zia
zanna run examples/apps/zannasql/tests/test_phase53_generated.zia
zanna run examples/apps/zannasql/tests/test_phase54_filter.zia
zanna run examples/apps/zannasql/tests/test_phase55_lateral.zia
zanna run examples/apps/zannasql/tests/test_phase56_natural_using.zia
zanna run examples/apps/zannasql/tests/test_phase57_setops_all.zia
zanna run examples/apps/zannasql/tests/test_phase58_fetch_first.zia
zanna run examples/apps/zannasql/tests/test_phase59_grouping_sets.zia
zanna run examples/apps/zannasql/tests/test_phase60_distinct_on.zia
zanna run examples/apps/zannasql/tests/test_phase61_window_frames.zia
zanna run examples/apps/zannasql/tests/test_phase62_nulls_first_last.zia
zanna run examples/apps/zannasql/tests/test_phase63_window_funcs.zia
zanna run examples/apps/zannasql/tests/test_phase64_is_distinct.zia
zanna run examples/apps/zannasql/tests/test_phase65_if_exists.zia
zanna run examples/apps/zannasql/tests/test_phase66_show_create.zia
zanna run examples/apps/zannasql/tests/test_phase67_introspection.zia
zanna run examples/apps/zannasql/tests/test_phase68_table_pk_constraints.zia
zanna run examples/apps/zannasql/tests/test_phase69_query_extras.zia
zanna run examples/apps/zannasql/tests/test_phase70_query_features.zia
zanna run examples/apps/zannasql/tests/test_phase71_any_all_some.zia
zanna run examples/apps/zannasql/tests/test_phase72_window_exclude.zia

# Documentation examples (verifies all README examples)
zanna run examples/apps/zannasql/tests/test_readme_examples.zia
```
...
```bash
zanna build examples/apps/zannasql/tests/test_basic_crud.zia -o /tmp/test_sql && /tmp/test_sql
zanna build examples/apps/zannasql/tests/test_native_torture.zia -o /tmp/test_torture && /tmp/test_torture
```
