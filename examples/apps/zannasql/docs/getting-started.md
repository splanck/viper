...
```bash
zanna run examples/apps/zannasql/client/
```
...
```bash
zanna run examples/apps/zannasql/ -- --repl
```
...
```bash
zanna build examples/apps/zannasql/main.zia -o zannasql
./zannasql
```
...
```bash
zanna run examples/apps/zannasql/ -- --port 5433 --log-queries
```
