...
viper run examples/apps/vipersql/tests/test_basic_crud.zia
viper run examples/apps/vipersql/tests/test_advanced.zia

# Specific feature areas
viper run examples/apps/vipersql/tests/test_constraints.zia
viper run examples/apps/vipersql/tests/test_functions.zia
viper run examples/apps/vipersql/tests/test_subquery.zia
viper run examples/apps/vipersql/tests/test_index.zia
viper run examples/apps/vipersql/tests/test_sql_features.zia

# Multi-database and persistence
viper run examples/apps/vipersql/tests/test_multidb.zia
viper run examples/apps/vipersql/tests/test_persistence.zia

# Storage engine internals
viper run examples/apps/vipersql/tests/test_storage.zia
viper run examples/apps/vipersql/tests/test_btree.zia
viper run examples/apps/vipersql/tests/test_engine.zia
viper run examples/apps/vipersql/tests/test_wal.zia
viper run examples/apps/vipersql/tests/test_txn.zia

# Stress tests and native codegen validation
viper run examples/apps/vipersql/tests/test_storage_persistence.zia
viper run examples/apps/vipersql/tests/test_storage_stress.zia
viper run examples/apps/vipersql/tests/test_native_stress.zia
viper run examples/apps/vipersql/tests/test_native_edge.zia
viper run examples/apps/vipersql/tests/test_native_torture.zia
viper run examples/apps/vipersql/tests/test_native_extreme.zia

# Phase feature tests
viper run examples/apps/vipersql/tests/test_phase1.zia
viper run examples/apps/vipersql/tests/test_phase2.zia
viper run examples/apps/vipersql/tests/test_phase3.zia
viper run examples/apps/vipersql/tests/test_phase3_txn.zia
viper run examples/apps/vipersql/tests/test_phase4_functions.zia
viper run examples/apps/vipersql/tests/test_phase4_cte.zia
viper run examples/apps/vipersql/tests/test_phase4_multitable.zia
viper run examples/apps/vipersql/tests/test_phase4_window.zia
viper run examples/apps/vipersql/tests/test_phase4_datetime.zia

# Multi-user and server tests
viper run examples/apps/vipersql/tests/test_multiuser.zia
viper run examples/apps/vipersql/tests/test_system_views.zia
viper run examples/apps/vipersql/tests/test_tempdb.zia
viper run examples/apps/vipersql/tests/test_auth.zia
viper run examples/apps/vipersql/tests/test_pg_wire.zia
viper run examples/apps/vipersql/tests/test_extended_query.zia

# Triggers, sequences, stored functions, composite indexes, pg_catalog, JSON
viper run examples/apps/vipersql/tests/test_phase17_triggers.zia
viper run examples/apps/vipersql/tests/test_phase18_sequences.zia
viper run examples/apps/vipersql/tests/test_phase19_procedures.zia
viper run examples/apps/vipersql/tests/test_phase20_composite_indexes.zia
viper run examples/apps/vipersql/tests/test_phase21_pg_catalog.zia
viper run examples/apps/vipersql/tests/test_phase25_json.zia
viper run examples/apps/vipersql/tests/test_phase26_vacuum.zia
viper run examples/apps/vipersql/tests/test_phase27_pg_stat.zia
viper run examples/apps/vipersql/tests/test_phase28_partition.zia
viper run examples/apps/vipersql/tests/test_phase29_extensions.zia
viper run examples/apps/vipersql/tests/test_phase30_prepared.zia
viper run examples/apps/vipersql/tests/test_phase32_cursors.zia
viper run examples/apps/vipersql/tests/test_phase33_savepoints.zia
viper run examples/apps/vipersql/tests/test_phase34_copy.zia
viper run examples/apps/vipersql/tests/test_phase35_call.zia
viper run examples/apps/vipersql/tests/test_phase36_arrays.zia
viper run examples/apps/vipersql/tests/test_phase37_matviews.zia
viper run examples/apps/vipersql/tests/test_phase38_expressions.zia
viper run examples/apps/vipersql/tests/test_phase39_ctas.zia
viper run examples/apps/vipersql/tests/test_phase40_aggregates.zia
viper run examples/apps/vipersql/tests/test_phase41_do_blocks.zia
viper run examples/apps/vipersql/tests/test_phase42_insert.zia
viper run examples/apps/vipersql/tests/test_phase43_session.zia
viper run examples/apps/vipersql/tests/test_phase44_sysfuncs.zia
viper run examples/apps/vipersql/tests/test_phase45_alter_col.zia
viper run examples/apps/vipersql/tests/test_phase46_sqlfuncs.zia
viper run examples/apps/vipersql/tests/test_phase47_recursive_cte.zia
viper run examples/apps/vipersql/tests/test_phase48_math.zia
viper run examples/apps/vipersql/tests/test_phase49_strings.zia
viper run examples/apps/vipersql/tests/test_phase50_datetime.zia
viper run examples/apps/vipersql/tests/test_phase51_regex.zia
viper run examples/apps/vipersql/tests/test_phase52_inherit.zia
viper run examples/apps/vipersql/tests/test_phase53_generated.zia
viper run examples/apps/vipersql/tests/test_phase54_filter.zia
viper run examples/apps/vipersql/tests/test_phase55_lateral.zia
viper run examples/apps/vipersql/tests/test_phase56_natural_using.zia
viper run examples/apps/vipersql/tests/test_phase57_setops_all.zia
viper run examples/apps/vipersql/tests/test_phase58_fetch_first.zia
viper run examples/apps/vipersql/tests/test_phase59_grouping_sets.zia
viper run examples/apps/vipersql/tests/test_phase60_distinct_on.zia
viper run examples/apps/vipersql/tests/test_phase61_window_frames.zia
viper run examples/apps/vipersql/tests/test_phase62_nulls_first_last.zia
viper run examples/apps/vipersql/tests/test_phase63_window_funcs.zia
viper run examples/apps/vipersql/tests/test_phase64_is_distinct.zia
viper run examples/apps/vipersql/tests/test_phase65_if_exists.zia
viper run examples/apps/vipersql/tests/test_phase66_show_create.zia
viper run examples/apps/vipersql/tests/test_phase67_introspection.zia
viper run examples/apps/vipersql/tests/test_phase68_table_pk_constraints.zia
viper run examples/apps/vipersql/tests/test_phase69_query_extras.zia
viper run examples/apps/vipersql/tests/test_phase70_query_features.zia
viper run examples/apps/vipersql/tests/test_phase71_any_all_some.zia
viper run examples/apps/vipersql/tests/test_phase72_window_exclude.zia

# Documentation examples (verifies all README examples)
viper run examples/apps/vipersql/tests/test_readme_examples.zia
```
...
```bash
viper build examples/apps/vipersql/tests/test_basic_crud.zia -o /tmp/test_sql && /tmp/test_sql
viper build examples/apps/vipersql/tests/test_native_torture.zia -o /tmp/test_torture && /tmp/test_torture
```
