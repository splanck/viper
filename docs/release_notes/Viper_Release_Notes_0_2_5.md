...
- **TLS / Crypto** — native RSA (Montgomery ladder, RSA-PSS-SHA256), in-tree X.509 chain validator with EKU (drops `Security.framework`), in-tree `timegm`, PBKDF2 iterations 100K→300K.
