...
|---|---|---|---|
| Commits | — | 93 | +93 |
| Source files | 2,869 | 2,955 | +86 |
| Production SLOC | 450K | 524K | +74K |
...
See `git log a91d388db..HEAD -- .` for the full 93-commit history. The pattern throughout is feature introduction followed by hardening follow-ups in the same subsystem.
