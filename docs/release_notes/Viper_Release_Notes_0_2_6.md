...
| Production SLOC | 552K | 633K | +81K |
| Test SLOC | 228K | 264K | +36K |
| Demo SLOC | 188K | 190K | +2K |

Counts via `scripts/count_sloc.sh` (production 633,335 / test 264,208 / demo 189,784 / source files 3,058).
...
See `git log v0.2.5-dev..HEAD -- .` for the full 229-commit history since v0.2.5.
