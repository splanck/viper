...
|---|---|---|---|
| Commits | — | 100 | +100 |
| Source files | 3,096 | 3,341 | +245 |
| Production SLOC | 669K | 720K | +51K |
| Test SLOC | 278K | 297K | +19K |
| Demo SLOC | 192K | 193K | +1K |

Counts via `scripts/count_sloc.sh` (production 719,692 / test 296,672 / demo 193,429 / source files 3,341); commits since the `v0.2.6-dev` tag (2026-06-01).
