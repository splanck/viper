...
- **Demos & Documentation** — XENOSCAPE Metroid-style sidescroller (17K LOC), 3D bowling (3.1K LOC), 3D world starter demo, ViperSQL, ViperIDE, Chess, 8 Graphics3D API demos, plus a comprehensive 186-file documentation audit and 700+ new Doxygen comments across the runtime.
