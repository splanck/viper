...
The Zanna Studio polish pass fixes editor and popup behaviors that are implemented
...
- keyboard navigation supports Shift selection, word movement, and word delete
  without duplicating that behavior in Zanna Studio command handlers.
...
the same behavior without Zanna Studio-specific event code. Tests cover triple-click
