...
A comprehensive reference for ViperLang syntax and features. This appendix is designed for quick lookup -- for deeper understanding, follow the cross-references to the relevant chapters.
...
ViperLang provides built-in types for common data.
