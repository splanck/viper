...
```bash
# Chess (357KB binary)
./build/src/tools/ilc/ilc front basic -emit-il demos/chess/chess.bas > /tmp/chess.il
...
# Vtris (298KB binary)
./build/src/tools/ilc/ilc front basic -emit-il demos/vtris/vtris.bas > /tmp/vtris.il
