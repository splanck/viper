...
The bytecode backend intentionally supports a subset of IL. Unsupported bytecode lowering, such as `gaddr` for global data addressing, is reported as a `V-BC-*` compile diagnostic before the bytecode VM starts.
