# CODEMAP: ViperLang Frontend

The ViperLang frontend (`src/frontends/viperlang/`) compiles ViperLang source to IL.

ViperLang is Viper's native language with entities, generics, and imports.
...
| File                | Purpose                                    |
|---------------------|--------------------------------------------|
| `Lexer.hpp/cpp`     | Tokenizer for ViperLang source             |
