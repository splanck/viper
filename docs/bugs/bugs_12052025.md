...
Both demos compile successfully to native binaries but crash at runtime. The crash is likely due to their use of CONST
values inside class methods (BUG-002 and BUG-003).
