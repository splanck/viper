...
The stress test successfully identified critical regressions. The good news: the core compiler infrastructure is solid. The problem is localized to OOP field access, which is fixable.
