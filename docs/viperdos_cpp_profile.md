...
The ViperDOS C++ Profile defines:
...
These features are **NOT required** for ViperDOS and may be omitted or implemented last:
...
| vcpp Phase | ViperDOS Tier | Deliverable |
|------------|--------------|-------------|
