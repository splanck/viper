...
static void ping_task_fn(void *arg)
{
    ...
    sys::debug_print("[ping] Starting ping task\n");
    ...
    sys::debug_print("[ping] Ping task done!\n");
    if (gcon::is_available())
    {
        gcon::puts("  Ping task done!\n");
    }
...
static void pong_task_fn(void *arg)
{
    ...
    sys::debug_print("[pong] Starting pong task\n");
    ...
    sys::debug_print("[pong] Pong task done!\n");
    if (gcon::is_available())
    {
        gcon::puts("  Pong task done!\n");
    }
