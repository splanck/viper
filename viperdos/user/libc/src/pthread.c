...
// Purpose: POSIX threads stubs for ViperDOS libc.
...
/**
 * @file pthread.c
 * @brief POSIX threads stubs for ViperDOS libc.
 *
 * @details
 * This file provides minimal pthreads compatibility for single-threaded
 * programs. ViperDOS does not currently support multi-threading, so:
 *
