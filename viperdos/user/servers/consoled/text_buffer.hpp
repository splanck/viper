...
public:
    ...
    // Initialization
    bool init(gui_window_t *window, uint32_t cols, uint32_t rows,
    ...
    // Cursor management
    uint32_t cursor_x() const { return m_cursor_x; }
    uint32_t cursor_y() const { return m_cursor_y; }
    ...
    uint32_t default_fg() const { return m_default_fg; }
    uint32_t default_bg() const { return m_default_bg; }
    ...
    bool needs_present() const { return m_needs_present; }
    void set_needs_present(bool v) { m_needs_present = v; }
    void clear_needs_present() { m_needs_present = false; }
