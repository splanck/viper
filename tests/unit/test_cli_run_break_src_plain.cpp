...
int runWithArgs(const std::string &file, const std::string &flag, const std::string &spec, std::string &stderrText)
{
...
int main()
{
    const std::filesystem::path tmpDir = std::filesystem::temp_directory_path() / "viper_cli_break_plain";
    std::error_code ec;
