...
// VIPER_RUNTIME_NS_DUAL
    ...
    DescriptorRow{"rt_canvas_should_close",
                  ...
                  0,
                  RuntimeTrapClass::None},
    DescriptorRow{"Viper.Graphics.Canvas.Line",
                  std::nullopt,
                  "void(ptr,i64,i64,i64,i64,i64)",
                  &DirectHandler<&rt_canvas_line,
                                 void,
                                 void *,
                                 int64_t,
                                 int64_t,
    ...
    DescriptorRow{"rt_canvas_line",
                  ...
                  0,
                  RuntimeTrapClass::None},
    DescriptorRow{"Viper.Graphics.Canvas.Box",
                  std::nullopt,
                  "void(ptr,i64,i64,i64,i64,i64)",
                  &DirectHandler<&rt_canvas_box,
                                 void,
                                 void *,
                                 int64_t,
                                 int64_t,
    ...
    DescriptorRow{"rt_canvas_frame",
                  ...
                  0,
                  RuntimeTrapClass::None},
    DescriptorRow{"Viper.Graphics.Canvas.Disc",
                  std::nullopt,
                  "void(ptr,i64,i64,i64,i64)",
                  &DirectHandler<&rt_canvas_disc, void, void *, int64_t, int64_t, int64_t, int64_t>::
                      invoke,
                  kManualLowering,
                  nullptr,
                  0,
    ...
    DescriptorRow{
        ...
        0,
        RuntimeTrapClass::None},
    DescriptorRow{"Viper.Graphics.Canvas.Ring",
                  std::nullopt,
                  "void(ptr,i64,i64,i64,i64)",
                  &DirectHandler<&rt_canvas_ring,
                                 void,
                                 void *,
                                 int64_t,
                                 int64_t,
    ...
    DescriptorRow{"rt_color_rgb",
                  ...
                  0,
                  RuntimeTrapClass::None},
    DescriptorRow{"Viper.Graphics.Color.RGBA",
                  std::nullopt,
                  "i64(i64,i64,i64,i64)",
                  &DirectHandler<&rt_color_rgba, int64_t, int64_t, int64_t, int64_t, int64_t>::
                      invoke,
                  kManualLowering,
                  nullptr,
                  0,
                  RuntimeTrapClass::None},
    DescriptorRow{"rt_color_rgba",
                  std::nullopt,
                  "i64(i64,i64,i64,i64)",
                  &DirectHandler<&rt_color_rgba, int64_t, int64_t, int64_t, int64_t, int64_t>::
                      invoke,
