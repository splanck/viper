...
constexpr std::array<DescriptorRow, 88> kDescriptorRows{{
    ...
    DescriptorRow{"rt_lof_ch", std::nullopt, "i32(i32)", &DirectHandler<&rt_lof_ch, int32_t, int32_t>::invoke, kManualLowering, nullptr, 0, RuntimeTrapClass::None},
    DescriptorRow{"rt_loc_ch", std::nullopt, "i32(i32)", &DirectHandler<&rt_loc_ch, int32_t, int32_t>::invoke, kManualLowering, nullptr, 0, RuntimeTrapClass::None},
