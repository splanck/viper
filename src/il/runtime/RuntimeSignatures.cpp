...
// VIPER_RUNTIME_NS_DUAL
    ...
    DescriptorRow{"rt_gfx_draw_line",
                  ...
                  &DirectHandler<&rt_gfx_draw_line,
                                 void,
                                 void *,
                                 int64_t,
                                 int64_t,
    ...
    DescriptorRow{"rt_gfx_draw_rect",
                  std::nullopt,
                  "void(ptr,i64,i64,i64,i64,i64)",
                  &DirectHandler<&rt_gfx_draw_rect,
                                 void,
                                 void *,
                                 int64_t,
                                 int64_t,
    ...
    DescriptorRow{"rt_gfx_draw_rect_outline",
                  std::nullopt,
                  "void(ptr,i64,i64,i64,i64,i64)",
                  &DirectHandler<&rt_gfx_draw_rect_outline,
                                 void,
                                 void *,
                                 int64_t,
                                 int64_t,
    ...
    DescriptorRow{
        ...
        &DirectHandler<&rt_gfx_draw_circle, void, void *, int64_t, int64_t, int64_t, int64_t>::
            invoke,
        kManualLowering,
        nullptr,
        0,
    ...
    DescriptorRow{"rt_gfx_draw_circle_outline",
                  std::nullopt,
                  "void(ptr,i64,i64,i64,i64)",
                  &DirectHandler<&rt_gfx_draw_circle_outline,
                                 void,
                                 void *,
                                 int64_t,
                                 int64_t,
