...
void register_array_signatures() {
    ...
    register_signature(make_signature("rt_arr_i32_get_fast", {Kind::Ptr, Kind::I64}, {Kind::I64}));
    register_signature(make_signature("rt_arr_i32_set", {Kind::Ptr, Kind::I64, Kind::I64}));
    register_signature(make_signature("rt_arr_i32_set_fast", {Kind::Ptr, Kind::I64, Kind::I64}));
    ...
    register_signature(make_signature("rt_arr_i64_get_fast", {Kind::Ptr, Kind::I64}, {Kind::I64}));
    register_signature(make_signature("rt_arr_i64_set", {Kind::Ptr, Kind::I64, Kind::I64}));
    register_signature(make_signature("rt_arr_i64_set_fast", {Kind::Ptr, Kind::I64, Kind::I64}));
    ...
    register_signature(make_signature("rt_arr_f64_get_fast", {Kind::Ptr, Kind::I64}, {Kind::F64}));
    register_signature(make_signature("rt_arr_f64_set", {Kind::Ptr, Kind::I64, Kind::F64}));
    register_signature(make_signature("rt_arr_f64_set_fast", {Kind::Ptr, Kind::I64, Kind::F64}));
