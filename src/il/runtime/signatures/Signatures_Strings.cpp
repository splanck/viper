...
void register_string_signatures()
{
    ...
    register_signature(make_signature("rt_substr",
    ...
    register_signature(make_signature("rt_split_fields",
                                      {Kind::Ptr, Kind::Ptr, Kind::I64},
                                      {Kind::I64}));
    ...
    register_signature(make_signature("rt_parse_int64",
                                      {Kind::Ptr, Kind::Ptr},
                                      {Kind::I32}));
    register_signature(make_signature("rt_parse_double",
                                      {Kind::Ptr, Kind::Ptr},
                                      {Kind::I32}));
    ...
    register_signature(make_signature("rt_mid3",
                                      {Kind::Ptr, Kind::I64, Kind::I64},
                                      {Kind::Ptr}));
    register_signature(make_signature("rt_instr2", {Kind::Ptr, Kind::Ptr}, {Kind::I64}));
    register_signature(make_signature("rt_instr3",
                                      {Kind::I64, Kind::Ptr, Kind::Ptr},
                                      {Kind::I64}));
    ...
    register_signature(make_signature("rt_str_eq", {Kind::Ptr, Kind::Ptr}, {Kind::I32}));
    register_signature(make_signature("rt_val", {Kind::Ptr}, {Kind::F64}));
    register_signature(make_signature("rt_val_to_double",
                                      {Kind::Ptr, Kind::Ptr},
                                      {Kind::F64}));
