...
inline constexpr std::array<std::string_view, kRtSigCount> kRtSigSymbolNames = {
    "rt_print_str",     "rt_print_i64",     "rt_print_f64",    "rt_len",          "rt_substr",
    "rt_trap",          "rt_concat",        "rt_input_line",   "rt_split_fields", "rt_to_int",
    "rt_to_double",     "rt_parse_int64",   "rt_parse_double", "rt_int_to_str",   "rt_f64_to_str",
    "rt_str_i16_alloc",    "rt_str_i32_alloc",       "rt_str_f_alloc",      "rt_str_d_alloc",
