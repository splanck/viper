...
/// @details The parser operates over mutable IR, so the constructor captures the
///          module by reference rather than by value.  Storing the reference
///          guarantees that parsed functions, globals, and extern declarations
///          mutate the caller-owned module directly while avoiding copies or
///          lifetime ownership ambiguities.
///
