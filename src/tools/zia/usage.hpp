...
/// @file
/// @brief Declarations for Zia CLI usage and version text.
/// @details Used by the `zia` driver and legacy compatibility shims to keep
...
/// @brief Print version information for the Zia CLI.
