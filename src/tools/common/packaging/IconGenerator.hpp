...
//
// Key invariants:
//   - Source image may be any non-empty RGBA image; standard icon sizes are
//     generated by resizing up or down as needed.
...
///
/// Produces entries for standard sizes (32, 64, 128, 256, 512, 1024). Each
/// entry contains a PNG resized from the source image.
///
...
///
/// Produces entries for standard sizes (16, 24, 32, 48, 64, 128, 256). Each
/// entry embeds a PNG resized from the source image.
///
...
/// (16, 32, 48, 128, 256), resized from the source image.
///
/// @param srcImage Source RGBA image.
