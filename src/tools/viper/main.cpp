...
void usage() {
    std::cerr
        ...
        << "           [--bounds-checks|--no-bounds-checks] [--dump-trap] [--debug-vm] [-O0|-O1|-O2]\n"
        ...
        << "       viper front zia -emit-il <file.zia> [--bounds-checks|--no-bounds-checks] [--no-runtime-namespaces]\n"
        << "       viper front zia -run <file.zia> [--trace=il|src] [--stdin-from <file>] "
           "[--max-steps N] [--bounds-checks|--no-bounds-checks] [--dump-trap] [--debug-vm] [--no-runtime-namespaces]\n"
        ...
        << "                         [--native-asm|--system-asm] "
           "[--native-link|--system-link(deprecated)]\n"
