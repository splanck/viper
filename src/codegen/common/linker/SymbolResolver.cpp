...
static bool isKnownDynamicSymbol(const std::string &name)
{
    ...
    static const char *const kDynSymExact[] = {
        ...
        "pthread_once", "pthread_rwlock_init", "pthread_rwlock_rdlock",
        ...
        "sysconf", "getpid", "getuid",
        "signal", "sigaction", "raise",
        "setjmp", "longjmp", "_setjmp", "_longjmp",
        "qsort", "bsearch",
        "isalpha", "isdigit", "isspace", "toupper", "tolower",
        "strerror", "perror",
        "sscanf", "vsnprintf", "vfprintf",
        "setvbuf", "setbuf", "freopen", "tmpfile", "tmpnam",
        "getc", "putc", "fgetc", "fputc", "ungetc",
        "ferror", "feof", "clearerr", "rewind",
        "_Exit",
        "posix_memalign", "aligned_alloc", "reallocf",
        "access", "dup", "dup2", "pipe", "fork", "execv", "execve",
        "waitpid", "wait",
        "fcntl", "ioctl",
        "fileno", "isatty", "ttyname",
        // POSIX scheduling / threads
        "sched_yield",
        // Math
        "sin", "cos", "tan", "asin", "acos", "atan", "atan2",
        "sinf", "cosf", "tanf", "asinf", "acosf", "atanf", "atan2f",
        "sqrt", "sqrtf", "pow", "powf", "exp", "expf", "log", "logf", "log2", "log10",
        "ceil", "ceilf", "floor", "floorf", "round", "roundf",
        "fmod", "fmodf", "fabs", "fabsf", "fmin", "fminf", "fmax", "fmaxf",
        "copysign", "copysignf", "trunc", "truncf",
        // macOS specific
        "_NSGetExecutablePath", "dyld_stub_binder",
        "_tlv_atexit", "_tlv_bootstrap",
        "mach_timebase_info", "mach_absolute_time",
        "mach_task_self_", "mach_host_self",
        "task_info", "host_page_size",
