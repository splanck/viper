...
// Purpose: Declare a reusable pipeline that lowers IL modules to native code via the x86-64 backend.
// Key invariants: The pipeline sequences parsing, verification, adaptation, and emission in a
...
public:
    ...
    struct Options
    {
        ...
        std::string output_obj_path;    ///< Destination executable/object file path; empty disables linking.
