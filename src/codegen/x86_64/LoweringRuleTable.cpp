...
const std::array<RuleSpec, 51> kLoweringRuleTable = {
    ...
    RuleSpec{"add",
             ...
             RuleFlags::None, &emitAdd, "add"},
    RuleSpec{"sub",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitSub, "sub"},
    RuleSpec{"mul",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitMul, "mul"},
    // === Overflow-Checked Arithmetic ===
    RuleSpec{"iadd.ovf",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitAddOvf, "iadd.ovf"},
    RuleSpec{"isub.ovf",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitSubOvf, "isub.ovf"},
    RuleSpec{"imul.ovf",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitMulOvf, "imul.ovf"},
    RuleSpec{"fdiv",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitFDiv, "fdiv"},
    // === Bitwise Operations ===
    RuleSpec{"and",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitAnd, "and"},
    RuleSpec{"or",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitOr, "or"},
    RuleSpec{"xor",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitXor, "xor"},
    // === Comparison Operations ===
    RuleSpec{"icmp_",
             OperandShape{2U, 3U, 3U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Immediate, OperandKindPattern::Any}},
             RuleFlags::Prefix, &emitICmp, "icmp"},
    RuleSpec{"fcmp_",
             OperandShape{2U, 3U, 3U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Immediate, OperandKindPattern::Any}},
             RuleFlags::Prefix, &emitFCmp, "fcmp"},
    // === Division/Remainder ===
    RuleSpec{"div",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitDivFamily, "div"},
    RuleSpec{"sdiv",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitDivFamily, "sdiv"},
    RuleSpec{"srem",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitDivFamily, "srem"},
    RuleSpec{"udiv",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitDivFamily, "udiv"},
    RuleSpec{"urem",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitDivFamily, "urem"},
    RuleSpec{"rem",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitDivFamily, "rem"},
    // === Shift Operations ===
    RuleSpec{"shl",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitShiftLeft, "shl"},
    RuleSpec{"lshr",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitShiftLshr, "lshr"},
    RuleSpec{"ashr",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitShiftAshr, "ashr"},
    // === Comparison (explicit CMP) ===
    RuleSpec{"cmp",
             OperandShape{2U, 3U, 3U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Immediate, OperandKindPattern::Any}},
             RuleFlags::None, &emitCmpExplicit, "cmp"},
    // === Control Flow ===
    RuleSpec{"select",
             OperandShape{3U, 3U, 3U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Value, OperandKindPattern::Any}},
             RuleFlags::None, &emitSelect, "select"},
    RuleSpec{"br",
             OperandShape{1U, 1U, 1U,
                          {OperandKindPattern::Label, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitBranch, "br"},
    RuleSpec{"cbr",
             OperandShape{3U, 3U, 3U,
                          {OperandKindPattern::Value, OperandKindPattern::Label,
                           OperandKindPattern::Label, OperandKindPattern::Any}},
             RuleFlags::None, &emitCondBranch, "cbr"},
    RuleSpec{"ret",
             OperandShape{0U, 1U, 1U,
                          {OperandKindPattern::Value, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitReturn, "ret"},
    // === Calls ===
    RuleSpec{"call",
             OperandShape{1U, std::numeric_limits<std::uint8_t>::max(), 1U,
                          {OperandKindPattern::Label, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitCall, "call"},
    RuleSpec{"call.indirect",
             OperandShape{1U, std::numeric_limits<std::uint8_t>::max(), 1U,
                          {OperandKindPattern::Value, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitCallIndirect, "call.indirect"},
    // === Memory Operations ===
    RuleSpec{"load",
             OperandShape{1U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Immediate,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitLoadAuto, "load"},
    RuleSpec{"store",
             OperandShape{2U, 3U, 3U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Immediate, OperandKindPattern::Any}},
             RuleFlags::None, &emitStore, "store"},
    // === Type Conversions ===
    RuleSpec{"zext",
             OperandShape{1U, 1U, 1U,
                          {OperandKindPattern::Value, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitZSTrunc, "zext"},
    RuleSpec{"sext",
             OperandShape{1U, 1U, 1U,
                          {OperandKindPattern::Value, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitZSTrunc, "sext"},
    RuleSpec{"trunc",
             OperandShape{1U, 1U, 1U,
                          {OperandKindPattern::Value, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitZSTrunc, "trunc"},
    RuleSpec{"sitofp",
             OperandShape{1U, 1U, 1U,
                          {OperandKindPattern::Value, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitSIToFP, "sitofp"},
    RuleSpec{"fptosi",
             OperandShape{1U, 1U, 1U,
                          {OperandKindPattern::Value, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitFPToSI, "fptosi"},
    RuleSpec{"fptosi_chk",
             OperandShape{1U, 1U, 1U,
                          {OperandKindPattern::Value, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitFPToSIChecked, "fptosi_chk"},
    // === Exception Handling ===
    RuleSpec{"eh.push",
             OperandShape{1U, 1U, 1U,
                          {OperandKindPattern::Label, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitEhPush, "eh.push"},
    ...
    RuleSpec{"trap",
             OperandShape{0U, 1U, 1U,
                          {OperandKindPattern::Value, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitTrap, "trap"},
    RuleSpec{"const_str",
             OperandShape{1U, 1U, 1U,
                          {OperandKindPattern::Value, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitConstStr, "const_str"},
    RuleSpec{"alloca",
             OperandShape{1U, 1U, 1U,
                          {OperandKindPattern::Immediate, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitAlloca, "alloca"},
    RuleSpec{"gep",
             OperandShape{2U, 2U, 2U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitGEP, "gep"},
    // === Constants, Addresses, Casts, Checks, Control Flow ===
    RuleSpec{"const_null",
             OperandShape{0U, 0U, 0U,
                          {OperandKindPattern::Any, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitConstNull, "const_null"},
    RuleSpec{"const_f64",
             OperandShape{1U, 1U, 1U,
                          {OperandKindPattern::Any, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitConstF64, "const_f64"},
    RuleSpec{"gaddr",
             OperandShape{1U, 1U, 1U,
                          {OperandKindPattern::Any, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitGAddr, "gaddr"},
    RuleSpec{"addr_of",
             OperandShape{1U, 1U, 1U,
                          {OperandKindPattern::Value, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitAddrOf, "addr_of"},
    RuleSpec{"idx_chk",
             OperandShape{3U, 3U, 3U,
                          {OperandKindPattern::Value, OperandKindPattern::Value,
                           OperandKindPattern::Value, OperandKindPattern::Any}},
             RuleFlags::None, &emitIdxChk, "idx_chk"},
    RuleSpec{"switch_i32",
             OperandShape{2U, std::numeric_limits<std::uint8_t>::max(), 1U,
                          {OperandKindPattern::Value, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitSwitchI32, "switch_i32"},
    RuleSpec{"fptoui",
             OperandShape{1U, 1U, 1U,
                          {OperandKindPattern::Value, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitFpToUi, "fptoui"},
    RuleSpec{"uitofp",
             OperandShape{1U, 1U, 1U,
                          {OperandKindPattern::Value, OperandKindPattern::Any,
                           OperandKindPattern::Any, OperandKindPattern::Any}},
             RuleFlags::None, &emitUiToFp, "uitofp"},
};
