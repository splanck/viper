...
/// @brief Lower zero-/sign-truncate IL instructions to a plain MOV.
/// @details Truncation between integer widths is a register-to-register
///          move at the machine level (the high bits become don't-cares).
///          Sub-64-bit consumers that care about value-range correctness
///          must use the checked variants instead.
/// @param instr IL trunc instruction.
/// @param builder Active MIR builder.
