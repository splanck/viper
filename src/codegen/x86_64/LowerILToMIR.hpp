...
struct ILValue {
  enum class Kind { I64, F64, I1, PTR, LABEL };
...
private:
  ...
  [[nodiscard]] Operand makeOperandForValue(MBasicBlock& block, const ILValue& value,
                                            RegClass cls);
  ...
  void lowerBinary(const ILInstr& instr, MBasicBlock& block, MOpcode opcRR,
                   MOpcode opcRI, RegClass cls);
  ...
  void lowerCast(const ILInstr& instr, MBasicBlock& block, MOpcode opc,
