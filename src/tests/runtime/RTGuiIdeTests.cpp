...
int main() {
    ...
    rt_gui_test_harness_register_widget(
        h, rt_const_cstr("editor"), rt_const_cstr("CodeEditor"), rt_const_cstr("Editor"), 10, 10, 300, 200);
    rt_gui_test_harness_register_widget(
        h, rt_const_cstr("results"), rt_const_cstr("List"), rt_const_cstr("Search Results"), 10, 220, 300, 120);
    ...
    rt_virtual_tree_add_node(tree, rt_const_cstr("src"), rt_const_cstr("main.zia"), rt_const_cstr("main.zia"));
    ...
    rt_command_state_set_accessible(command, rt_const_cstr("Build project"), rt_const_cstr("Compile active project"));
    ...
    assert(rt_map_get_int(rt_accessibility_high_contrast_tokens(), rt_const_cstr("foreground")) == 0xffffff);
    return 0;
}
