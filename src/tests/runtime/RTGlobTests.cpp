...
static void test_glob_match()
{
    ...
    // Test 1: Literal match
    {
        ...
        test_result("Literal match", rt_glob_match(pattern, path) == 1);
    }
    ...
    // Test 2: Literal non-match
    {
        ...
        test_result("Literal non-match", rt_glob_match(pattern, path) == 0);
    }
    ...
    // Test 3: * wildcard
    {
        ...
        rt_string path = rt_const_cstr("hello.txt");
        test_result("* matches prefix", rt_glob_match(pattern, path) == 1);
    }
    ...
    // Test 4: * doesn't match /
    {
        ...
        test_result("* doesn't match /", rt_glob_match(pattern, path) == 0);
    }
    ...
    // Test 5: ** matches /
    {
        rt_string pattern = rt_const_cstr("**/*.txt");
        rt_string path = rt_const_cstr("dir/hello.txt");
        test_result("**/ matches directories", rt_glob_match(pattern, path) == 1);
    }
    ...
    // Test 6: ** matches multiple directories
    {
        ...
        test_result("** matches deep paths", rt_glob_match(pattern, path) == 1);
    }
    ...
    // Test 7: ? wildcard
    {
        ...
        test_result("? matches single char", rt_glob_match(pattern, path) == 1);
    }
    ...
    // Test 8: ? doesn't match multiple chars
    {
        ...
        test_result("? doesn't match multiple", rt_glob_match(pattern, path) == 0);
    }
    ...
    // Test 10: Complex pattern
    {
        ...
        test_result("Complex pattern", rt_glob_match(pattern, path) == 1);
    }
    ...
    // Test 11: * at end
    {
        ...
        test_result("* at end matches", rt_glob_match(pattern, path) == 1);
    }
    ...
    // Test 12: Multiple *
    {
        ...
        test_result("Multiple * matches", rt_glob_match(pattern, path) == 1);
    }
