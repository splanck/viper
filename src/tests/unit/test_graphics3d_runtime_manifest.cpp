...
constexpr std::size_t kExpectedFunctionCount = 2096;
constexpr std::size_t kExpectedClassCount = 126;
constexpr std::size_t kExpectedPropertyCount = 746;
constexpr std::size_t kExpectedMethodCount = 1136;
...
int main() {
    ...
    constexpr std::uint64_t kExpectedManifestHash = UINT64_C(0x06b1e9bac86e34a5);
