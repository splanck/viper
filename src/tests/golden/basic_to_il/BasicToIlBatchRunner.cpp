...
[[nodiscard]] std::string normalizeRuntimeAliases(std::string text, bool includeDiagAssert) {
    ...
    const std::vector<AliasPair> aliases = {
        ...
        {"rt_to_int", "Viper.Convert.ToInt"},
        {"rt_to_double", "Viper.Convert.ToDouble"},
        {"rt_parse_int64", "Viper.Parse.Int64"},
        {"rt_parse_double", "Viper.Parse.Double"},
        {"rt_int_to_str", "Viper.Convert.ToString_Int"},
        {"rt_f64_to_str", "Viper.Convert.ToString_Double"},
