...
result = Viper.Text.Fmt.Int(0)
PRINT "Int(0): '"; result; "'"

result = Viper.Text.Fmt.Int(-1)
PRINT "Int(-1): '"; result; "'"

result = Viper.Text.Fmt.Int(9223372036854775807)
...
result = Viper.Text.Fmt.Num(0.0)
PRINT "Num(0.0): '"; result; "'"

result = Viper.Text.Fmt.Num(-0.0)
PRINT "Num(-0.0): '"; result; "'"

result = Viper.Text.Fmt.Num(1.0)
PRINT "Num(1.0): '"; result; "'"

result = Viper.Text.Fmt.Num(0.1)
PRINT "Num(0.1): '"; result; "'"

result = Viper.Text.Fmt.Num(0.123456789)
PRINT "Num(0.123456789): '"; result; "'"

result = Viper.Text.Fmt.Num(1234567890.123)
PRINT "Num(1234567890.123): '"; result; "'"

result = Viper.Text.Fmt.Num(0.0000001)
PRINT "Num(0.0000001): '"; result; "'"

result = Viper.Text.Fmt.Num(1e10)
PRINT "Num(1e10): '"; result; "'"

result = Viper.Text.Fmt.Num(1e-10)
...
result = Viper.Text.Fmt.NumFixed(1.23456789, 0)
PRINT "NumFixed(1.23456789, 0): '"; result; "'"

result = Viper.Text.Fmt.NumFixed(1.23456789, 2)
PRINT "NumFixed(1.23456789, 2): '"; result; "'"

result = Viper.Text.Fmt.NumFixed(1.23456789, 10)
PRINT "NumFixed(1.23456789, 10): '"; result; "'"

result = Viper.Text.Fmt.NumFixed(1.23456789, -1)
...
result = Viper.Text.Fmt.Hex(0)
PRINT "Hex(0): '"; result; "'"

result = Viper.Text.Fmt.Hex(255)
PRINT "Hex(255): '"; result; "'"

result = Viper.Text.Fmt.Hex(65535)
PRINT "Hex(65535): '"; result; "'"

result = Viper.Text.Fmt.Hex(-1)
PRINT "Hex(-1): '"; result; "'"

result = Viper.Text.Fmt.HexPad(255, 4)
PRINT "HexPad(255, 4): '"; result; "'"

result = Viper.Text.Fmt.HexPad(255, 8)
...
result = Viper.Text.Fmt.Bin(0)
PRINT "Bin(0): '"; result; "'"

result = Viper.Text.Fmt.Bin(255)
PRINT "Bin(255): '"; result; "'"

result = Viper.Text.Fmt.Bin(-1)
PRINT "Bin(-1): '"; result; "'"
PRINT ""
...
result = Viper.Text.Fmt.Oct(0)
PRINT "Oct(0): '"; result; "'"

result = Viper.Text.Fmt.Oct(64)
PRINT "Oct(64): '"; result; "'"

result = Viper.Text.Fmt.Oct(511)
...
result = Viper.Text.Fmt.IntRadix(255, 2)
PRINT "IntRadix(255, 2): '"; result; "'"

result = Viper.Text.Fmt.IntRadix(255, 16)
PRINT "IntRadix(255, 16): '"; result; "'"

result = Viper.Text.Fmt.IntRadix(100, 10)
PRINT "IntRadix(100, 10): '"; result; "'"

result = Viper.Text.Fmt.IntRadix(35, 36)
PRINT "IntRadix(35, 36): '"; result; "'"

' Edge case: radix out of range
result = Viper.Text.Fmt.IntRadix(10, 1)
PRINT "IntRadix(10, 1) [invalid radix]: '"; result; "'"

result = Viper.Text.Fmt.IntRadix(10, 37)
