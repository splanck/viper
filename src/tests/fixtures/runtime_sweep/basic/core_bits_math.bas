...
' COVER: Viper.Math.Bits.CountOnes
' COVER: Viper.Math.Bits.Flip
' COVER: Viper.Math.Bits.Get
' COVER: Viper.Math.Bits.CountLeadingZeros
' COVER: Viper.Math.Bits.Not
' COVER: Viper.Math.Bits.Or
' COVER: Viper.Math.Bits.RotateLeft
' COVER: Viper.Math.Bits.RotateRight
...
' COVER: Viper.Math.Bits.CountTrailingZeros
' COVER: Viper.Math.Bits.ShiftRightLogical
...
Viper.Core.Diagnostics.AssertEq(Viper.Math.Bits.ShiftRightLogical(8, 2), 2, "bits.ushr")
...
Viper.Core.Diagnostics.AssertEq(Viper.Math.Bits.CountOnes(255), 8, "bits.count")
Viper.Core.Diagnostics.AssertEq(Viper.Math.Bits.CountLeadingZeros(1), 63, "bits.leadz")
Viper.Core.Diagnostics.AssertEq(Viper.Math.Bits.CountTrailingZeros(8), 3, "bits.trailz")
Viper.Core.Diagnostics.AssertEq(Viper.Math.Bits.Swap(72623859790382856), 578437695752307201, "bits.swap")
Viper.Core.Diagnostics.AssertEq(Viper.Math.Bits.RotateLeft(1, 1), 2, "bits.rotl")
Viper.Core.Diagnostics.AssertEq(Viper.Math.Bits.RotateRight(2, 1), 1, "bits.rotr")
...
AssertApprox(Viper.Math.ToDegrees(Viper.Math.Pi), 180, 0.01, "math.deg")
...
AssertApprox(Viper.Math.ToRadians(180), Viper.Math.Pi, 0.0001, "math.rad")
AssertApprox(Viper.Math.Round(1.6), 2, eps, "math.round")
AssertApprox(Viper.Math.Sign(-3), -1, eps, "math.sgn")
Viper.Core.Diagnostics.AssertEq(Viper.Math.SignInt(-3), -1, "math.sgnint")
...
AssertApprox(Viper.Math.Truncate(-2.7), -2, eps, "math.trunc")
...
DIM rf AS DOUBLE
rf = Viper.Math.Random.NextDouble()
