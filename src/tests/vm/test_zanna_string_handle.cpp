...
//===----------------------------------------------------------------------===//
//
// File: src/tests/vm/test_zanna_string_handle.cpp
//
//===----------------------------------------------------------------------===//
// SPDX-License-Identifier: GPL-3.0-only
// File: tests/vm/test_zanna_string_handle.cpp
// Purpose: Validate ZannaStringHandle RAII retains/releases correctly.
...
int main() {
    ...
    reset_counts();
    {
        ...
        {
            il::vm::ZannaStringHandle h1(s);
            {
                il::vm::ZannaStringHandle h2(h1);
    ...
    reset_counts();
    {
        ...
        {
            il::vm::ZannaStringHandle h1(s1);
            il::vm::ZannaStringHandle h2(s2);
            h2 = h1;
    ...
    reset_counts();
    {
        rt_string s = make_owned("m");
        {
            il::vm::ZannaStringHandle h1(s);
            {
                il::vm::ZannaStringHandle h2(std::move(h1));
