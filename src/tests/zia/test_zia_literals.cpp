...
func start() {    var a = 0.0;
    var b = 3.14159;
    var c = 1.0;
    Zanna.Terminal.Say("floats work");
}
)";
...
func start() {    var a = 1e10;
    var b = 2.5e-3;
    Zanna.Terminal.Say("scientific notation works");
}
)";
...
func start() {    var a: String = "hello";
    ...
    Zanna.Terminal.Say(a);
    Zanna.Terminal.Say(b);
    Zanna.Terminal.Say(c);
    Zanna.Terminal.Say(d);
}
)";
...
func start() {    var empty: List[Integer] = [];
    ...
    Zanna.Terminal.SayInt(strings.count());
}
)";
...
func start() {    var pair = (1, "hello");
    ...
    Zanna.Terminal.SayInt(pair.0);
    Zanna.Terminal.Say(pair.1);
}
)";
