...
//===----------------------------------------------------------------------===//
//
// Tests for ViperLang entity types (OOP features).
//
//===----------------------------------------------------------------------===//
...
TEST(ViperLangEntities, BasicFields)
{
    SourceManager sm;
...
func start() {
    ...
    CompilerInput input{.source = source, .path = "point.viper"};
...
TEST(ViperLangEntities, BasicMethods)
{
    SourceManager sm;
    const std::string source = R"(
module Test;
...
func start() {
    ...
    CompilerInput input{.source = source, .path = "counter.viper"};
    CompilerOptions opts{};
...
TEST(ViperLangEntities, MethodWithParameters)
{
    SourceManager sm;
    const std::string source = R"(
module Test;
...
func start() {
    ...
    CompilerInput input{.source = source, .path = "calculator.viper"};
    CompilerOptions opts{};
...
TEST(ViperLangEntities, Visibility)
{
    SourceManager sm;
    const std::string source = R"(
module Test;
...
TEST(ViperLangEntities, SelfReference)
{
    SourceManager sm;
    const std::string source = R"(
module Test;
...
func start() {
    ...
    CompilerInput input{.source = source, .path = "selfref.viper"};
    CompilerOptions opts{};
...
TEST(ViperLangEntities, EntityComposition)
{
    SourceManager sm;
    const std::string source = R"(
module Test;
...
func start() {
    ...
    CompilerInput input{.source = source, .path = "composition.viper"};
    CompilerOptions opts{};
...
TEST(ViperLangEntities, VariousFieldTypes)
{
    SourceManager sm;
    const std::string source = R"(
module Test;
...
func start() {
    ...
    CompilerInput input{.source = source, .path = "player.viper"};
    CompilerOptions opts{};
...
TEST(ViperLangEntities, EntityLists)
{
    SourceManager sm;
    const std::string source = R"(
module Test;
...
func start() {
    ...
    CompilerInput input{.source = source, .path = "inventory.viper"};
    CompilerOptions opts{};
...
TEST(ViperLangEntities, FieldDefaults)
{
    SourceManager sm;
    const std::string source = R"(
module Test;
...
func start() {
    ...
    CompilerInput input{.source = source, .path = "fielddefaults.viper"};
    CompilerOptions opts{};
...
TEST(ViperLangEntities, ArrowReturnType)
{
    SourceManager sm;
    const std::string source = R"(
module Test;
...
func start() {
    ...
    CompilerInput input{.source = source, .path = "arrowret.viper"};
    CompilerOptions opts{};
...
TEST(ViperLangEntities, ColonReturnType)
{
    SourceManager sm;
    const std::string source = R"(
module Test;
...
func start() {
    ...
    CompilerInput input{.source = source, .path = "colonret.viper"};
    CompilerOptions opts{};
