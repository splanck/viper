...
typedef enum {
    ...
    VGFX_KEY_SPACE = ' ',
    VGFX_KEY_0 = '0', VGFX_KEY_1, VGFX_KEY_2, VGFX_KEY_3, VGFX_KEY_4,
    VGFX_KEY_5, VGFX_KEY_6, VGFX_KEY_7, VGFX_KEY_8, VGFX_KEY_9,
    VGFX_KEY_A = 'A', VGFX_KEY_B, VGFX_KEY_C, VGFX_KEY_D, VGFX_KEY_E,
    VGFX_KEY_F, VGFX_KEY_G, VGFX_KEY_H, VGFX_KEY_I, VGFX_KEY_J,
    VGFX_KEY_K, VGFX_KEY_L, VGFX_KEY_M, VGFX_KEY_N, VGFX_KEY_O,
    VGFX_KEY_P, VGFX_KEY_Q, VGFX_KEY_R, VGFX_KEY_S, VGFX_KEY_T,
    VGFX_KEY_U, VGFX_KEY_V, VGFX_KEY_W, VGFX_KEY_X, VGFX_KEY_Y,
    VGFX_KEY_Z,
