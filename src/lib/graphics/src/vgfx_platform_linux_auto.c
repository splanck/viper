...
#define DECLARE_ADAPTER(prefix)                                                                    \
    ...
    int prefix##_vgfx_platform_set_text_input_state(struct vgfx_window *, const vgfx_text_input_state_t *)
...
DISPATCH_VOID(vgfx_platform_get_position, (struct vgfx_window *w, int32_t *x, int32_t *y), (w, x, y))
...
DISPATCH_VOID(vgfx_platform_get_monitor_size, (struct vgfx_window *w, int32_t *x, int32_t *y), (w, x, y))
DISPATCH_VOID(vgfx_platform_set_window_size, (struct vgfx_window *w, int32_t x, int32_t y), (w, x, y))
...
DISPATCH_RET(int, vgfx_platform_set_text_input_enabled, (struct vgfx_window *w, int32_t v), (w, v), 0)
DISPATCH_RET(int,
