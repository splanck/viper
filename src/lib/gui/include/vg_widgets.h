...
extern "C"
{
    ...
    void vg_button_set_on_click(vg_button_t *button,
                                vg_button_callback_t callback,
                                void *user_data);
    ...
    typedef void (*vg_text_change_callback_t)(vg_widget_t *input,
                                              const char *text,
                                              void *user_data);
    ...
    typedef void (*vg_listbox_data_provider_t)(vg_widget_t *listbox,
                                               size_t index,
                                               const char **text,
                                               struct vg_icon *icon,
                                               void *user_data);
    ...
    vg_listbox_item_t *vg_listbox_add_item(vg_listbox_t *listbox,
                                           const char *text,
                                           void *user_data);
    ...
    /// @brief Set change callback
    void vg_slider_set_on_change(vg_slider_t *slider,
                                 vg_slider_callback_t callback,
                                 void *user_data);
