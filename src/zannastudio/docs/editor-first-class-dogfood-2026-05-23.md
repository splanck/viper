# Archived Zanna Studio Dogfood Report - 2026-05-23
...
- Runtime: macOS 26.5, production `zannastudio/bin/zannastudio`.
- Profile isolation: temporary `HOME=/tmp/zannastudio-dogfood-home.Omfc79`.
- Perf log: `ZANNASTUDIO_PERF_LOG=/tmp/zannastudio-dogfood-final2.log`.
...
Current status has changed since this report. In particular, Zanna Studio now has
