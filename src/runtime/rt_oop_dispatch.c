...
// Key invariants: vptr points to an array of function pointers; slot indices are bounds-checked at
// runtime. Ownership/Lifetime: Does not own object memory; returns raw function pointers for
// indirect calls. Links: src/runtime/rt_oop.h
