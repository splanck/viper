...
// Leaves
static rt_plural_rule_node_t g_card_var_i = {
    .kind = RT_PRN_VAR, .u = { .var = { .var = RT_PVAR_I, .mod = 0 } } };
static rt_plural_rule_node_t g_card_int_1 = {
    .kind = RT_PRN_INT, .u = { .int_val = 1 } };
static rt_plural_rule_node_t g_card_var_v = {
    .kind = RT_PRN_VAR, .u = { .var = { .var = RT_PVAR_V, .mod = 0 } } };
static rt_plural_rule_node_t g_card_int_0 = {
    .kind = RT_PRN_INT, .u = { .int_val = 0 } };
...
static rt_plural_rule_node_t g_ord_var_nmod10 = {
    .kind = RT_PRN_VAR, .u = { .var = { .var = RT_PVAR_N, .mod = 10 } } };
static rt_plural_rule_node_t g_ord_var_nmod100 = {
    .kind = RT_PRN_VAR, .u = { .var = { .var = RT_PVAR_N, .mod = 100 } } };
