...
//   - copy_region_pixels returns a fresh Pixels object owned by the caller.
//
// Ownership/Lifetime:
//   - retain_ref / release_ref_slot adjust GC refcounts on borrowed handles.
//
...
void blit_pixels(void *dst, int64_t dx, int64_t dy, void *src, int64_t sx, int64_t sy, int64_t width,
