                                                                          ...
                                                                          RT_MATERIAL3D_TEXTURE_SLOT_COUNT) "];"
                                                                                                            ...
                                                                                                            "[" VGFX3D_STR(RT_MATERIAL3D_TEXTURE_SLOT_COUNT) "];\n"
                                                                                                                                                             ...
                                                                                                                                                             "    int cascadeCount = clamp(light.shadowCascadeCount, 1, " VGFX3D_STR(VGFX3D_MAX_SHADOW_LIGHTS) ");\n"
                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                               "        return shadowAtlas.sample_compare(shadowSampler, auv, depth - bias);\n"
                                                                                                                                                                                                                                                               "    }\n"
                                                                                                                                                                                                                                                               "    if (shadowIndex == 0)\n"
                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                               "        return 1.0;\n"
                                                                                                                                                                                                                                                               "    float2 mapSize;\n"
                                                                                                                                                                                                                                                               "    if (shadowIndex >= 4) mapSize = float2(shadowAtlas.get_width() * 0.25, shadowAtlas.get_height() * 0.5);\n"
                                                                                                                                                                                                                                                               "    else if (shadowIndex == 0) mapSize = float2(shadowMap0.get_width(), shadowMap0.get_height());\n"
                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                               "        return 1.0;\n"
                                                                                                                                                                                                                                                               "    float3 suv = light.shadowProjectionType != 0 ? lc.xyz / lc.w : lc.xyz;\n"
                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                               "        lit += sample_shadow_at(shadowIndex, suv.xy + o, suv.z, bias, shadowMap0, shadowMap1, shadowMap2, shadowMap3, shadowAtlas, shadowSampler);\n"
                                                                                                                                                                                                                                                               "    }\n"
                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                               "    int binnedLightCount;\n"
                                                                                                                                                                                                                                                               "    int overflowCount;\n"
                                                                                                                                                                                                                                                               "    float znear;\n"
                                                                                                                                                                                                                                                               "    float zfar;\n"
                                                                                                                                                                                                                                                               "    ushort offsets[" VGFX3D_STR(VGFX3D_CLUSTER_COUNT) " + 1];\n"
                                                                                                                                                                                                                                                                                                                      "    ushort indices[" VGFX3D_STR(
                                                                                                                                                                                                                                                                                                                          VGFX3D_MAX_CLUSTER_LIGHT_INDICES) "];\n"
                                                                                                                                                                                                                                                                                                                                                            "};\n"
                                                                                                                                                                                                                                                                                                                                                            "\n"
                                                                                                                                                                                                                                                                                                                                                            "int cluster_fragment_index(constant ClusterTable &tbl, constant PerScene &scene,\n"
                                                                                                                                                                                                                                                                                                                                                            "                           float2 fragXY, float3 worldPos) {\n"
                                                                                                                                                                                                                                                                                                                                                            "    float u = fragXY.x / max(scene.clusterParams.x, 1.0);\n"
                                                                                                                                                                                                                                                                                                                                                            "    float v = fragXY.y / max(scene.clusterParams.y, 1.0);\n"
                                                                                                                                                                                                                                                                                                                                                            "    int cx = clamp(int(u * float(" VGFX3D_STR(
                                                                                                                                                                                                                                                                                                                                                                VGFX3D_CLUSTER_DIM_X) ")), 0,\n"
                                                                                                                                                                                                                                                                                                                                                                                      "                   " VGFX3D_STR(VGFX3D_CLUSTER_DIM_X) " - 1);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                             "    int cy = clamp(int(v * float(" VGFX3D_STR(
                                                                                                                                                                                                                                                                                                                                                                                                                                                 VGFX3D_CLUSTER_DIM_Y) ")), 0,\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                       "                   " VGFX3D_STR(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                           VGFX3D_CLUSTER_DIM_Y) " - 1);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "    float zn = max(tbl.znear, 1e-4);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "    float zf = max(tbl.zfar, zn * 1.001);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "    float depth = dot(worldPos - scene.cameraPosition.xyz, scene.cameraForward.xyz);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "    int cz = 0;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "    if (depth >= zf)\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "        cz = " VGFX3D_STR(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     VGFX3D_CLUSTER_DIM_Z) " - 1;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           "    else if (depth > zn)\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           "        cz = clamp(int(floor(float(" VGFX3D_STR(VGFX3D_CLUSTER_DIM_Z) ") * log(depth / zn) /\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  "                             log(zf / zn))),\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  "                   0, " VGFX3D_STR(VGFX3D_CLUSTER_DIM_Z) " - 1);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            "    return cx + cy * " VGFX3D_STR(VGFX3D_CLUSTER_DIM_X) " +\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     "           cz * (" VGFX3D_STR(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         VGFX3D_CLUSTER_DIM_X) " * " VGFX3D_STR(VGFX3D_CLUSTER_DIM_Y) ");\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "    constant ClusterTable &clusterTable [[buffer(3)]],\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "    texture2d<float> diffuseTex [[texture(0)]],\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "    depth2d<float> shadowAtlas [[texture(17)]],\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "    depth2d<float> opaqueDepthTex [[texture(16)]],\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "    sampler diffuseSampler [[sampler(0)]],\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "    if (material.pbrFlags.y == 2 && material.pbrScalars1.z > 0.0 &&\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        scene.clusterParams.z > 0.0 && scene.clusterParams.w > scene.clusterParams.z) {\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        float zn = scene.clusterParams.z;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        float zf = scene.clusterParams.w;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        float sceneD = opaqueDepthTex.read(uint2(in.position.xy));\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        float fragD = in.position.z;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        float linScene;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        float linFrag;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        if (scene.cameraPosition.w > 0.5) {\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        }\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        finalAlpha *= clamp((linScene - linFrag) / material.pbrScalars1.z, 0.0, 1.0);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "    }\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        }\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        if (scene.fogColor.a > 0.5 || scene.heightFog.z > 0.0) {\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "            float fogRange = scene.fogParams.y - scene.fogParams.x;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "            float fogFactor = clamp((viewDistance - scene.fogParams.x) / max(fogRange, "
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "0.001), 0.0, 1.0);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "            if (scene.fogColor.a <= 0.5) fogFactor = 0.0;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "            if (scene.heightFog.z > 0.0) {\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "                float hd = scene.heightFog.z * exp(-(in.worldPos.y - scene.heightFog.x) * scene.heightFog.y);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "                float hf = clamp(1.0 - exp(-hd * viewDistance), 0.0, 1.0);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        out.motion.w = material.pbrScalars1.w;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        return out;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "    }\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        }\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        int lightLoopCount = scene.counts.x;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        int clusterStart = 0;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        if (scene.counts.z >= 0) {\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "            int cidx = cluster_fragment_index(clusterTable, scene, in.position.xy,\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "                                              in.worldPos);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "            clusterStart = int(clusterTable.offsets[cidx]);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "            lightLoopCount =\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "                scene.counts.z + (int(clusterTable.offsets[cidx + 1]) - clusterStart);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        }\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "        for (int k = 0; k < lightLoopCount; k++) {\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "            int i = (scene.counts.z < 0 || k < scene.counts.z)\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "                        ? k\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "                        : int(clusterTable.indices[clusterStart + (k - scene.counts.z)]);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "scene, shadowMap0, shadowMap1, shadowMap2, shadowMap3, shadowAtlas, shadowSampler));\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "            if (NdotL <= 0.0)\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "                continue;\n"
...
typedef struct {
    ...
    /* Plan 07: x/y = viewport size for froxel lookup (z/w spare). counts[2]
     * carries the global-light prefix length, or -1 for the flat light loop. */
    float cluster_params[4];
    /* Track E doc 07: exponential height fog (x = base, y = falloff,
     * z = density*blend with 0 = off, w = pad). Appended so all earlier
     * offsets stay byte-identical to the MSL PerScene (BUG-E7 contract). */
    float height_fog[4];
} mtl_per_scene_t;
...
static id<MTLBuffer> metal_cluster_buffer_for_table(VGFXMetalContext *ctx,
    ...
    int32_t slot;
    if (!table || table->lights_revision == 0)
        return nil;
...
static id<MTLSamplerState> metal_get_material_sampler(VGFXMetalContext *ctx,
    ...
    anisotropy = filter == RT_MATERIAL3D_TEXTURE_FILTER_NEAREST
                     ? 1
                     : vgfx3d_metal_sanitize_anisotropy(anisotropy);
    NSString *key = [NSString stringWithFormat:@"%d:%d:%d:%d", wrap_s, wrap_t, filter, anisotropy];
                ...
                if (pfxVS) {
                    ...
                    }
                    {
                        ...
                        if (ssrFS) {
                            ...
                            /* SSR writes into the BGRA8 postfx ping-pong targets. */
                            sd.colorAttachments[0].pixelFormat = MTLPixelFormatBGRA8Unorm;
                            ctx.ssrPipeline = [device newRenderPipelineStateWithDescriptor:sd
                                                                                     error:&pfxErr];
                        }
                    }
                }
...
static void metal_submit_draw(void *ctx_ptr,
    ...
    @autoreleasepool {
        ...
        if (lights_dirty) {
            ...
            clusterBuf = metal_cluster_buffer_for_table(
                ctx, (const vgfx3d_cluster_table_t *)cmd->cluster_table);
            scene.counts[2] =
                clusterBuf
                    ? ((const vgfx3d_cluster_table_t *)cmd->cluster_table)->global_light_count
                    : -1;
            scene.cluster_params[0] = (float)(ctx.rttActive ? ctx.rttWidth : ctx.width);
            scene.cluster_params[1] = (float)(ctx.rttActive ? ctx.rttHeight : ctx.height);
    ...
    @autoreleasepool {
        ...
        if (atlas_slot) {
            ...
            if (!ctx->_shadowAtlasTexture || ctx->_shadowAtlasTexture.width != atlas_w ||
                ...
                desc.storageMode = MTLStorageModePrivate;
                ctx->_shadowAtlasTexture = [ctx.device newTextureWithDescriptor:desc];
        ...
        if (atlas_slot) {
            ...
            rp.depthAttachment.loadAction = ctx->_shadowAtlasClearedSerial == ctx.frameSerial
                                                ? MTLLoadActionLoad
                                                : MTLLoadActionClear;
...
static id<MTLTexture> metal_encode_ssr_pass(VGFXMetalContext *ctx,
    ...
    sp.inv_resolution[0] = ctx.width > 0 ? 1.0f / (float)ctx.width : 0.0f;
    sp.inv_resolution[1] = ctx.height > 0 ? 1.0f / (float)ctx.height : 0.0f;
            ...
            if (postfx->effects[i].type == (int32_t)VGFX3D_POSTFX_EFFECT_TAA &&
                ...
                if (resolved) {
                    ...
                    output_texture =
                       ...
                       postfx->effects[i].snapshot.ssr_enabled) {
                output_texture = metal_encode_ssr_pass(
                    ctx, source_texture, target_texture, &postfx->effects[i].snapshot);
                if (!output_texture) /* prerequisites missing: pass source through */
                    output_texture =
                        metal_encode_postfx_pass(ctx, source_texture, target_texture, NULL, 0, nil);
            } else {
