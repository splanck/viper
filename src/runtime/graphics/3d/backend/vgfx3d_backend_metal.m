...
static NSString *metal_shader_source = @
    "#include <metal_stdlib>\n"
                                                                      ...
                                                                      "[" VGFX3D_STR(
                                                                          RT_MATERIAL3D_TEXTURE_SLOT_COUNT) "];"
                                                                                                            ...
                                                                                                            "[" VGFX3D_STR(RT_MATERIAL3D_TEXTURE_SLOT_COUNT) "];\n"
                                                                                                                                                             ...
                                                                                                                                                             "        return -1;\n"
                                                                                                                                                             "    int cascadeCount = clamp(light.shadowCascadeCount, 1, " VGFX3D_STR(
                                                                                                                                                                 VGFX3D_MAX_SHADOW_LIGHTS) ");\n"
                                        ...
                                        "    else if (shadowIndex == 0) mapSize = float2(shadowMap0.get_width(), shadowMap0.get_height());\n"
                                                                                                                                                                                           ...
                                                                                                                                                                                           "    float znear;\n"
                                                                                                                                                                                           "    float zfar;\n"
                                                                                                                                                                                           "    ushort offsets[" VGFX3D_STR(
                                                                                                                                                                                               VGFX3D_CLUSTER_COUNT) " + 1];\n"
                                                                                                                                                                                                                     "    ushort indices[" VGFX3D_STR(
                                                                                                                                                                                                                         VGFX3D_MAX_CLUSTER_LIGHT_INDICES) "];\n"
                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                           "    int cx = clamp(int(u * float(" VGFX3D_STR(VGFX3D_CLUSTER_DIM_X) ")), 0,\n"
                                                                                                                                                                                                                                                                                                                                "                   " VGFX3D_STR(
                                                                                                                                                                                                                                                                                                                                    VGFX3D_CLUSTER_DIM_X) " - 1);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "                   0, " VGFX3D_STR(VGFX3D_CLUSTER_DIM_Z) " - 1);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "    return cx + cy * " VGFX3D_STR(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    VGFX3D_CLUSTER_DIM_X) " +\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          "           cz * (" VGFX3D_STR(VGFX3D_CLUSTER_DIM_X) " * " VGFX3D_STR(VGFX3D_CLUSTER_DIM_Y) ");\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "}\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "\n"
...
static void metal_begin_frame(void *ctx_ptr, const vgfx3d_camera_params_t *cam) {
    @autoreleasepool {
        ...
        ctx->_heightFog[2] = cam->height_fog_enabled
...
static void metal_submit_draw(void *ctx_ptr,
    ...
    @autoreleasepool {
        ...
        }
        {
            ...
            id<MTLTexture> atlas = ctx->_shadowAtlasTexture
                                       ? ctx->_shadowAtlasTexture
                                       : metal_opaque_depth_dummy(ctx);
            if (atlas)
