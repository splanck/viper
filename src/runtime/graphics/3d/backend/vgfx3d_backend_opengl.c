...
static const char *const glsl_fragment_src[] = {
                                                                                                                                                                  ...
                                                                                                                                                                  "uniform int uLightShadowCascadeCount[" VGFX3D_STR(VGFX3D_MAX_LIGHTS) "];\n"
                                                                                                                                                                                                                                        "uniform vec4 uLightShadowCascadeSplits[" VGFX3D_STR(VGFX3D_MAX_LIGHTS) "];\n"
                                                                                                                                                                                                                                                                                                                "uniform vec3 uLightDir[" VGFX3D_STR(VGFX3D_MAX_LIGHTS) "];\n"
                                                                                                                                                                                                                                                                                                                                                                        "uniform vec3 uLightPos[" VGFX3D_STR(
                                                                                                                                                                                                                                                                                                                                                                            VGFX3D_MAX_LIGHTS) "];\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                         "uniform float uLightIntensity[" VGFX3D_STR(
                                                                                                                                                                                                                                                                                                                                                                                                                                                             VGFX3D_MAX_LIGHTS) "];\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "uniform float uLightAtten[" VGFX3D_STR(VGFX3D_MAX_LIGHTS) "];\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           "uniform float uLightInnerCos[" VGFX3D_STR(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               VGFX3D_MAX_LIGHTS) "];\n"
    ...
    "    int count = clamp(cascadeCount, 1, " VGFX3D_STR(
        VGFX3D_MAX_SHADOW_LIGHTS) ");\n"
                                  ...
                                  "shadowIndex;\n"
                                  "    if (viewDepth <= splits.y || count == 2) return shadowIndex "
                                  "+ 1;\n"
                                  "    if (viewDepth <= splits.z || count == 3) return shadowIndex "
                                  "+ 2;\n"
                                  "    return shadowIndex + 3;\n"
                                  "}\n"
                                  "vec2 shadowTexelSize(int shadowIndex) {\n"
                                  "    if (shadowIndex == 0) return 1.0 / "
                                  "vec2(textureSize(uShadowTex0, 0));\n"
                                  "    if (shadowIndex == 1) return 1.0 / "
                                  "vec2(textureSize(uShadowTex1, 0));\n"
                                  "    if (shadowIndex == 2) return 1.0 / "
                                  "vec2(textureSize(uShadowTex2, 0));\n"
                                  ...
                                  "}\n"
                                  "float sampleShadowMap(int shadowIndex, int cascadeCount, vec4 "
                                  "splits, vec3 worldPos) {\n"
                                  "    shadowIndex = resolveShadowCascade(shadowIndex, "
                                  "cascadeCount, splits, worldPos);\n"
                                  "    if (shadowIndex < 0 || shadowIndex >= uShadowCount) return "
                                  "1.0;\n"
                                  ...
                                  "                continue;\n"
                                  "            }\n"
                                  "            float smp = sampleShadowDepth(shadowIndex, sampleUv);\n"
...
/// @brief Whether the current GL context version is at least @p major.@p minor (parsed from
/// GL_VERSION).
