...
void Sema::initRuntimeFunctions()
{
    ...
    //==========================================================================
    // Phase 2: Register standalone function aliases from runtime.def (coarse)
    //==========================================================================
    // The ZiaRuntimeExterns.inc file is generated by rtgen from runtime.def.
    // It registers return types only (no param types) for all RT_FUNC entries.
    // Phase 3 below will override any entries here that have richer type info
    // (e.g. seq<str> return types become typed Seq[T] in Phase 3).
