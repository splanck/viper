...
#include <vector>
    ...
    struct BlockNamer
    {
        ...
        [[nodiscard]] std::string entry() const { return "entry_" + proc; }

        [[nodiscard]] std::string ret() const { return "ret_" + proc; }
        ...
        unsigned nextIf() { return ifCounter++; }
        ...
        unsigned nextWhile() { return loopCounter++; }
        ...
        unsigned nextDo() { return loopCounter++; }
        ...
        unsigned nextFor() { return loopCounter++; }

        /// @brief Allocate next sequential ID for a call continuation.
        unsigned nextCall() { return loopCounter++; }
    ...
    struct ProcedureContext
    {
        struct BlockNameState
        {
            ...
            [[nodiscard]] BlockNamer *namer() noexcept { return namer_.get(); }
            ...
            void resetNamer() noexcept { namer_.reset(); }
        ...
        struct ErrorHandlerState
        {
            ...
            [[nodiscard]] std::optional<size_t> activeIndex() const noexcept { return activeIndex_; }

            void setActiveIndex(std::optional<size_t> index) noexcept { activeIndex_ = index; }

            [[nodiscard]] std::optional<int> activeLine() const noexcept { return activeLine_; }

            void setActiveLine(std::optional<int> line) noexcept { activeLine_ = line; }

            [[nodiscard]] std::unordered_map<int, size_t> &blocks() noexcept { return blocks_; }
        ...
        struct GosubState
        {
            ...
            [[nodiscard]] bool hasPrologue() const noexcept { return hasPrologue_; }

            [[nodiscard]] Value spSlot() const noexcept { return spSlot_; }

            [[nodiscard]] Value stackSlot() const noexcept { return stackSlot_; }
        ...
        [[nodiscard]] LoopState &loopState() noexcept { return loopState_; }

        [[nodiscard]] const LoopState &loopState() const noexcept { return loopState_; }

        [[nodiscard]] BlockNameState &blockNames() noexcept { return blockNames_; }

        [[nodiscard]] const BlockNameState &blockNames() const noexcept { return blockNames_; }

        [[nodiscard]] ErrorHandlerState &errorHandlers() noexcept { return errorHandlers_; }
        ...
        [[nodiscard]] GosubState &gosub() noexcept { return gosub_; }

        [[nodiscard]] const GosubState &gosub() const noexcept { return gosub_; }
