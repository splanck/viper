...
// Purpose: Defines BASIC statement nodes and visitors for the front-end AST.
// Key invariants: Statements capture source locations and retain ownership of child nodes.
