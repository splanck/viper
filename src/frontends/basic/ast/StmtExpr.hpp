...
// Purpose: Defines BASIC expression-oriented statements (I/O, assignment, stateful).
// Key invariants: Expression-owned children remain non-null when required by semantics.
