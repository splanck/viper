...
// Purpose: Defines BASIC control-flow statement nodes for the front-end AST.
// Key invariants: Control nodes own their branch bodies and guard expressions.
// Ownership/Lifetime: Owned sub-statements managed via std::unique_ptr wrappers.
