...
// Purpose: Declares shared visitor interfaces and the base class for BASIC statements.
// Key invariants: Statement kind enumerators map one-to-one with concrete subclasses.
// Ownership/Lifetime: Statements own child nodes via std::unique_ptr managed externally.
