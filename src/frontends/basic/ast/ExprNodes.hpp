...
// Purpose: Defines BASIC expression AST nodes and visitor interfaces.
// Key invariants: Expression nodes track source locations and own child expressions.
// Ownership/Lifetime: Nodes are owned through ExprPtr handles managed by callers.
