...
// Purpose: Defines BASIC declaration statement nodes composing higher-level program structure.
// Key invariants: Declaration nodes own child statements and preserve declaration order.
