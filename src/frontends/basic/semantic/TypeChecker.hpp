// File: src/frontends/basic/semantic/TypeChecker.hpp
// Purpose: Declares BASIC type checker and symbol/label tracker.
// Key invariants: Analyzer tracks defined symbols and reports unknown references.
...
class TypeChecker
{
  public:
    ...
    explicit TypeChecker(DiagnosticEmitter &de) : de(de) {}
  ...
  private:
    ...
    class ScopedScope
    {
      public:
        ...
        explicit ScopedScope(TypeChecker &sa);
