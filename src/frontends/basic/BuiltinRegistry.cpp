...
static const std::array<LowerRule, 29> kBuiltinLoweringRules = {{
    ...
    { // CINT
        .result = {.kind = ResultSpec::Kind::Fixed, .type = Lowerer::ExprType::I16},
        .variants = {
            Variant{.condition = Condition::Always,
    ...
    { // CLNG
        .result = {.kind = ResultSpec::Kind::Fixed, .type = Lowerer::ExprType::I32},
        .variants = {
            Variant{.condition = Condition::Always,
                    .kind = VariantKind::Custom,
