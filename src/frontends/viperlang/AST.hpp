...
struct NamedType : TypeNode
{
    ...
    NamedType(SourceLoc l, std::string n)
...
struct OptionalType : TypeNode
{
    ...
    OptionalType(SourceLoc l, TypePtr i)
        : TypeNode(TypeKind::Optional, l), inner(std::move(i)) {}
};
...
struct IntLiteralExpr : Expr
{
    ...
    IntLiteralExpr(SourceLoc l, int64_t v)
...
struct NumberLiteralExpr : Expr
{
    ...
    NumberLiteralExpr(SourceLoc l, double v)
        : Expr(ExprKind::NumberLiteral, l), value(v) {}
};
...
struct BoolLiteralExpr : Expr
{
    ...
    BoolLiteralExpr(SourceLoc l, bool v)
...
{
    NullLiteralExpr(SourceLoc l)
        : Expr(ExprKind::NullLiteral, l) {}
};

/// Unit literal: ()
struct UnitLiteralExpr : Expr
{
    UnitLiteralExpr(SourceLoc l)
        : Expr(ExprKind::UnitLiteral, l) {}
};
...
{
    SelfExpr(SourceLoc l)
        : Expr(ExprKind::SelfExpr, l) {}
};
...
struct TernaryExpr : Expr
{
    ...
    TernaryExpr(SourceLoc l, ExprPtr c, ExprPtr t, ExprPtr e)
        : Expr(ExprKind::Ternary, l), condition(std::move(c)),
...
struct LambdaExpr : Expr
{
    ...
    LambdaExpr(SourceLoc l, std::vector<LambdaParam> p, TypePtr ret, ExprPtr b)
        : Expr(ExprKind::Lambda, l), params(std::move(p)),
...
struct IfExpr : Expr
{
    ...
    IfExpr(SourceLoc l, ExprPtr c, ExprPtr t, ExprPtr e)
        : Expr(ExprKind::If, l), condition(std::move(c)),
...
{
    struct Pattern {
        enum class Kind { Wildcard, Literal, Binding, Constructor, Tuple };
        Kind kind;
...
struct ForStmt : Stmt
{
    ...
    ForStmt(SourceLoc l, StmtPtr i, ExprPtr c, ExprPtr u, StmtPtr b)
        : Stmt(StmtKind::For, l), init(std::move(i)), condition(std::move(c)),
...
struct ForInStmt : Stmt
{
    ...
    ForInStmt(SourceLoc l, std::string v, ExprPtr i, StmtPtr b)
        : Stmt(StmtKind::ForIn, l), variable(std::move(v)),
          iterable(std::move(i)), body(std::move(b)) {}
};
...
struct FunctionDecl : Decl
{
    ...
    FunctionDecl(SourceLoc l, std::string n)
        : Decl(DeclKind::Function, l), name(std::move(n)) {}
};
...
struct FieldDecl : Decl
{
    ...
    FieldDecl(SourceLoc l, std::string n)
        : Decl(DeclKind::Field, l), name(std::move(n)) {}
};
...
struct MethodDecl : Decl
{
    ...
    MethodDecl(SourceLoc l, std::string n)
        : Decl(DeclKind::Method, l), name(std::move(n)) {}
};
...
struct ConstructorDecl : Decl
{
    ...
    ConstructorDecl(SourceLoc l)
        : Decl(DeclKind::Constructor, l) {}
};
...
struct ValueDecl : Decl
{
    ...
    ValueDecl(SourceLoc l, std::string n)
        : Decl(DeclKind::Value, l), name(std::move(n)) {}
};
...
struct EntityDecl : Decl
{
    ...
    EntityDecl(SourceLoc l, std::string n)
        : Decl(DeclKind::Entity, l), name(std::move(n)) {}
};
...
struct InterfaceDecl : Decl
{
    ...
    InterfaceDecl(SourceLoc l, std::string n)
        : Decl(DeclKind::Interface, l), name(std::move(n)) {}
};
...
struct ImportDecl : Decl
{
    ...
    ImportDecl(SourceLoc l, std::string p)
...
struct ModuleDecl : Decl
{
    ...
    ModuleDecl(SourceLoc l, std::string n)
        : Decl(DeclKind::Module, l), name(std::move(n)) {}
};
