# ZannaIDE Current Status

Last reviewed against source: 2026-07-04.

This file is the current-state reference for ZannaIDE. It intentionally avoids
future-phase language and records limitations in the same place as shipped
behavior.

## Summary

ZannaIDE is usable as a code editor and project workbench for Zia projects, with
...
The most accurate way to describe ZannaIDE today is "a functional Zanna
...
This distinction matters for documentation and release notes. ZannaIDE should
...
APIs, but ZannaIDE does not provide the user-facing workflow yet.
...
ZannaIDE does not yet keep a scene handle per open document, does not have
