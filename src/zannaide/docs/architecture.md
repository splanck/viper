# ZannaIDE Architecture

This document describes the current ZannaIDE source layout and ownership rules.
...
ZannaIDE is a frame-driven GUI application written in Zia. `src/main.zia`
...
legacy `~/.zannaide/settings.ini` compatibility. Settings are loaded once on
