...
This document is a detailed tour of `zannaide/src/`. It complements
...
ZannaIDE is organized around long-lived state objects that are created by
...
`zannaide/src/tests/` contains local GUI/runtime probe sources and small
