...
Viper.Diagnostics.AssertEq(r, 255, "Color.GetR red")
Viper.Diagnostics.AssertEq(g, 0, "Color.GetG red")
Viper.Diagnostics.AssertEq(b, 0, "Color.GetB red")
' RGB() returns 0x00RRGGBB, so alpha is 0
Viper.Diagnostics.AssertEq(a, 0, "Color.GetA RGB red")
...
Viper.Diagnostics.AssertEq(a, 128, "Color.GetA RGBA")

r = Viper.Graphics.Color.GetR(green)
g = Viper.Graphics.Color.GetG(green)
b = Viper.Graphics.Color.GetB(green)
Viper.Diagnostics.AssertEq(r, 0, "Color.GetR green")
Viper.Diagnostics.AssertEq(g, 255, "Color.GetG green")
Viper.Diagnostics.AssertEq(b, 0, "Color.GetB green")

' Test FromHSL - red is at hue 0
DIM hslRed AS INTEGER
hslRed = Viper.Graphics.Color.FromHSL(0, 100, 50)
Viper.Diagnostics.Assert(Viper.Graphics.Color.GetR(hslRed) > 200, "Color.FromHSL red R")
Viper.Diagnostics.Assert(Viper.Graphics.Color.GetG(hslRed) < 50, "Color.FromHSL red G")
Viper.Diagnostics.Assert(Viper.Graphics.Color.GetB(hslRed) < 50, "Color.FromHSL red B")

' Test Lerp
DIM lerped AS INTEGER
lerped = Viper.Graphics.Color.Lerp(red, blue, 50)
Viper.Diagnostics.Assert(Viper.Graphics.Color.GetR(lerped) > 100, "Color.Lerp R mid")
Viper.Diagnostics.Assert(Viper.Graphics.Color.GetB(lerped) > 100, "Color.Lerp B mid")
...
Viper.Diagnostics.Assert(Viper.Graphics.Color.GetR(bright) = 255, "Color.Brighten")
Viper.Diagnostics.Assert(Viper.Graphics.Color.GetR(dark) < 200, "Color.Darken")
...
Viper.Diagnostics.AssertEq(inverted.Width, 8, "Pixels.Invert width")
Viper.Diagnostics.AssertEq(inverted.Height, 8, "Pixels.Invert height")
' Red (255,0,0) inverted should be cyan (0,255,255)
DIM invColor AS INTEGER
invColor = inverted.Get(0, 0)
Viper.Diagnostics.AssertEq(Viper.Graphics.Color.GetR(invColor), 0, "Pixels.Invert R")
Viper.Diagnostics.AssertEq(Viper.Graphics.Color.GetG(invColor), 255, "Pixels.Invert G")
Viper.Diagnostics.AssertEq(Viper.Graphics.Color.GetB(invColor), 255, "Pixels.Invert B")

' Test Grayscale
DIM gray AS Viper.Graphics.Pixels
gray = pixels.Grayscale()
Viper.Diagnostics.AssertEq(gray.Width, 8, "Pixels.Grayscale width")
...
Viper.Diagnostics.AssertEq(grayR, grayG, "Pixels.Grayscale R=G")
...
Viper.Diagnostics.AssertEq(tinted.Width, 8, "Pixels.Tint width")

' Test Blur
DIM blurred AS Viper.Graphics.Pixels
blurred = pixels.Blur(1)
Viper.Diagnostics.AssertEq(blurred.Width, 8, "Pixels.Blur width")

' Test Resize
DIM resized AS Viper.Graphics.Pixels
resized = pixels.Resize(16, 16)
Viper.Diagnostics.AssertEq(resized.Width, 16, "Pixels.Resize width")
Viper.Diagnostics.AssertEq(resized.Height, 16, "Pixels.Resize height")
...
Viper.Diagnostics.AssertEq(sprite.X, 0, "Sprite.X initial")
Viper.Diagnostics.AssertEq(sprite.Y, 0, "Sprite.Y initial")
Viper.Diagnostics.AssertEq(sprite.Width, 16, "Sprite.Width")
Viper.Diagnostics.AssertEq(sprite.Height, 16, "Sprite.Height")
Viper.Diagnostics.AssertEq(sprite.Visible, 1, "Sprite.Visible initial")
Viper.Diagnostics.AssertEq(sprite.ScaleX, 100, "Sprite.ScaleX initial")
Viper.Diagnostics.AssertEq(sprite.ScaleY, 100, "Sprite.ScaleY initial")
Viper.Diagnostics.AssertEq(sprite.FrameCount, 1, "Sprite.FrameCount")
Viper.Diagnostics.AssertEq(sprite.Frame, 0, "Sprite.Frame initial")

' Test property setters
sprite.X = 10
sprite.Y = 20
Viper.Diagnostics.AssertEq(sprite.X, 10, "Sprite.X set")
Viper.Diagnostics.AssertEq(sprite.Y, 20, "Sprite.Y set")

sprite.ScaleX = 200
sprite.ScaleY = 150
Viper.Diagnostics.AssertEq(sprite.ScaleX, 200, "Sprite.ScaleX set")
Viper.Diagnostics.AssertEq(sprite.ScaleY, 150, "Sprite.ScaleY set")

sprite.Visible = 0
Viper.Diagnostics.AssertEq(sprite.Visible, 0, "Sprite.Visible set")
sprite.Visible = 1

' Test Move
sprite.Move(5, 5)
Viper.Diagnostics.AssertEq(sprite.X, 15, "Sprite.Move X")
Viper.Diagnostics.AssertEq(sprite.Y, 25, "Sprite.Move Y")

' Test Contains
DIM containsResult AS INTEGER
containsResult = sprite.Contains(15, 25)
Viper.Diagnostics.AssertEq(containsResult, 1, "Sprite.Contains inside")

containsResult = sprite.Contains(0, 0)
Viper.Diagnostics.AssertEq(containsResult, 0, "Sprite.Contains outside")
...
Viper.Diagnostics.AssertEq(tilemap.Width, 10, "Tilemap.Width")
Viper.Diagnostics.AssertEq(tilemap.Height, 8, "Tilemap.Height")
Viper.Diagnostics.AssertEq(tilemap.TileWidth, 16, "Tilemap.TileWidth")
Viper.Diagnostics.AssertEq(tilemap.TileHeight, 16, "Tilemap.TileHeight")

' Test SetTile and GetTile
tilemap.SetTile(0, 0, 1)
tilemap.SetTile(1, 0, 2)
tilemap.SetTile(2, 0, 3)
Viper.Diagnostics.AssertEq(tilemap.GetTile(0, 0), 1, "Tilemap.GetTile 0,0")
Viper.Diagnostics.AssertEq(tilemap.GetTile(1, 0), 2, "Tilemap.GetTile 1,0")
Viper.Diagnostics.AssertEq(tilemap.GetTile(2, 0), 3, "Tilemap.GetTile 2,0")

' Test Fill
tilemap.Fill(5)
Viper.Diagnostics.AssertEq(tilemap.GetTile(0, 0), 5, "Tilemap.Fill 0,0")
Viper.Diagnostics.AssertEq(tilemap.GetTile(9, 7), 5, "Tilemap.Fill 9,7")

' Test Clear
tilemap.Clear()
Viper.Diagnostics.AssertEq(tilemap.GetTile(0, 0), 0, "Tilemap.Clear 0,0")
...
Viper.Diagnostics.AssertEq(camera.Width, 320, "Camera.Width")
Viper.Diagnostics.AssertEq(camera.Height, 240, "Camera.Height")
Viper.Diagnostics.AssertEq(camera.X, 0, "Camera.X initial")
Viper.Diagnostics.AssertEq(camera.Y, 0, "Camera.Y initial")
Viper.Diagnostics.AssertEq(camera.Zoom, 100, "Camera.Zoom initial")

' Test property setters
camera.X = 100
camera.Y = 50
Viper.Diagnostics.AssertEq(camera.X, 100, "Camera.X set")
Viper.Diagnostics.AssertEq(camera.Y, 50, "Camera.Y set")

camera.Zoom = 200
Viper.Diagnostics.AssertEq(camera.Zoom, 200, "Camera.Zoom set")

' Test Move
camera.Move(10, 20)
Viper.Diagnostics.AssertEq(camera.X, 110, "Camera.Move X")
Viper.Diagnostics.AssertEq(camera.Y, 70, "Camera.Move Y")
...
Viper.Diagnostics.Assert(worldX >= 0, "Camera.ToWorldX valid")
Viper.Diagnostics.Assert(worldY >= 0, "Camera.ToWorldY valid")
