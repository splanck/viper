...
static void test_md5()
{
    ...
    test_result("Empty string MD5",
                strcmp(rt_string_cstr(md5_empty), "d41d8cd98f00b204e9800998ecf8427e") == 0);
    ...
    test_result("'abc' MD5",
                strcmp(rt_string_cstr(md5_abc), "900150983cd24fb0d6963f7d28e17f72") == 0);

    // "message digest": f96b697d7cb7938d525a2f31aaf161d0
    rt_string msg = rt_const_cstr("message digest");
    rt_string md5_msg = rt_hash_md5(msg);
    test_result("'message digest' MD5",
                strcmp(rt_string_cstr(md5_msg), "f96b697d7cb7938d525a2f31aaf161d0") == 0);

    // "abcdefghijklmnopqrstuvwxyz": c3fcd3d76192e4007dfb496cca67e13b
    rt_string alpha = rt_const_cstr("abcdefghijklmnopqrstuvwxyz");
    rt_string md5_alpha = rt_hash_md5(alpha);
    test_result("'a-z' MD5",
                strcmp(rt_string_cstr(md5_alpha), "c3fcd3d76192e4007dfb496cca67e13b") == 0);
...
static void test_sha1()
{
    ...
    test_result("Empty string SHA1",
                strcmp(rt_string_cstr(sha1_empty), "da39a3ee5e6b4b0d3255bfef95601890afd80709") ==
                    0);

    // "abc": a9993e364706816aba3e25717850c26c9cd0d89d
    rt_string abc = rt_const_cstr("abc");
    rt_string sha1_abc = rt_hash_sha1(abc);
    test_result("'abc' SHA1",
                strcmp(rt_string_cstr(sha1_abc), "a9993e364706816aba3e25717850c26c9cd0d89d") == 0);
    ...
    test_result("448-bit string SHA1",
                strcmp(rt_string_cstr(sha1_long), "84983e441c3bd26ebaae4aa1f95129e5e54670f1") == 0);
    ...
    test_result("'The quick brown fox...' SHA1",
                strcmp(rt_string_cstr(sha1_fox), "2fd4e1c67a2d28fced849ee1bb76e7391b93eb12") == 0);
...
static void test_sha256()
{
    ...
    test_result("Empty string SHA256",
                strcmp(rt_string_cstr(sha256_empty),
                       "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855") == 0);

    // "abc": ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad
    rt_string abc = rt_const_cstr("abc");
    rt_string sha256_abc = rt_hash_sha256(abc);
    test_result("'abc' SHA256",
                strcmp(rt_string_cstr(sha256_abc),
    ...
    test_result("448-bit string SHA256",
                strcmp(rt_string_cstr(sha256_long),
    ...
    test_result("'Hello' SHA256",
                strcmp(rt_string_cstr(sha256_hello),
                       "185f8db32271fe25f561a6fc938b2e264306ec304eda518007d1764826381969") == 0);
