...
Primary sources of truth:
	...
	• /docs/architecture.md#cpp-overview is an outline of how the C++ project should be laid out.
...
Non‑Goals (unless explicitly instructed):
	• No large refactors.
	• No spec changes to /docs/il-guide.md#reference.
	• No new external dependencies.
	• No breaking changes to public APIs without an ADR (Architecture Decision Record).

2) Core Principles
	1. Spec first: Obey /docs/il-guide.md#reference. If a task conflicts with the spec, create an ADR proposal; do not silently diverge.
...
Before you touch code:
	1. Read /docs/roadmap.md and the relevant section(s) of /docs/il-guide.md#reference.
...
8) Architectural Guardrails
	...
	• Spec compliance: Instruction semantics, traps, and typing must match /docs/il-guide.md#reference.
...
18) File Ownership & “Do Not Touch” List
	• Do not modify /docs/il-guide.md#reference without an ADR.
